...
copyinstr1(char *s)
{
  ...
  uint64 addrs[] = { 0x80000000LL, 0x3fffffe000, 0x3ffffff000, 0x4000000000,
      ...
      12:	6fa78793          	addi	a5,a5,1786 # 7708 <malloc+0x2588>
      16:	638c                	ld	a1,0(a5)
      18:	6790                	ld	a2,8(a5)
      1a:	6b94                	ld	a3,16(a5)
      1c:	6f98                	ld	a4,24(a5)
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
      ...
      6a:	21a50513          	addi	a0,a0,538 # 5280 <malloc+0x100>
      6e:	05e050ef          	jal	50cc <printf>
      exit(1);
      72:	4505                	li	a0,1
      ...
      94:	8082                	ret
{
      ...
      a4:	20050513          	addi	a0,a0,512 # 52a0 <malloc+0x120>
      a8:	024050ef          	jal	50cc <printf>
      exit(1);
      ac:	4505                	li	a0,1
...
00000000000000b2 <opentest>:
{
  ...
  fd = open("echo", 0);
      ...
      c4:	1f850513          	addi	a0,a0,504 # 52b8 <malloc+0x138>
  ...
  fd = open("doesnotexist", 0);
      ...
      da:	20250513          	addi	a0,a0,514 # 52d8 <malloc+0x158>
  ...
  if(fd >= 0){
    ...
    printf("%s: open echo failed!\n", s);
      ...
      f6:	1ce50513          	addi	a0,a0,462 # 52c0 <malloc+0x140>
      fa:	7d3040ef          	jal	50cc <printf>
    exit(1);
      fe:	4505                	li	a0,1
    ...
    printf("%s: open doesnotexist succeeded!\n", s);
     ...
     10a:	1e250513          	addi	a0,a0,482 # 52e8 <malloc+0x168>
     10e:	7bf040ef          	jal	50cc <printf>
    exit(1);
     112:	4505                	li	a0,1
...
0000000000000118 <truncate2>:
{
  ...
  unlink("truncfile");
     ...
     180:	19450513          	addi	a0,a0,404 # 5310 <malloc+0x190>
  ...
  close(fd2);
    ...
    printf("%s: write returned %d, expected -1\n", s, n);
     ...
     1aa:	18a50513          	addi	a0,a0,394 # 5330 <malloc+0x1b0>
     1ae:	71f040ef          	jal	50cc <printf>
    exit(1);
     1b2:	4505                	li	a0,1
...
000000000000022c <bigwrite>:
{
  ...
  unlink("bigwrite");
     ...
     248:	11450513          	addi	a0,a0,276 # 5358 <malloc+0x1d8>
     24c:	289040ef          	jal	4cd4 <unlink>
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     250:	1f300493          	li	s1,499
    fd = open("bigwrite", O_CREATE | O_RDWR);
     254:	00005a97          	auipc	s5,0x5
     258:	104a8a93          	addi	s5,s5,260 # 5358 <malloc+0x1d8>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     ...
     2c6:	0a650513          	addi	a0,a0,166 # 5368 <malloc+0x1e8>
     2ca:	603040ef          	jal	50cc <printf>
      exit(1);
     2ce:	4505                	li	a0,1
     ...
     2e0:	0ac50513          	addi	a0,a0,172 # 5388 <malloc+0x208>
     2e4:	5e9040ef          	jal	50cc <printf>
        exit(1);
     2e8:	4505                	li	a0,1
...
badwrite(char *s)
{
  ...
  unlink("junk");
     ...
     302:	0a250513          	addi	a0,a0,162 # 53a0 <malloc+0x220>
     306:	1cf040ef          	jal	4cd4 <unlink>
     30a:	25800913          	li	s2,600
  for(int i = 0; i < assumed_free; i++){
    int fd = open("junk", O_CREATE|O_WRONLY);
     30e:	00005997          	auipc	s3,0x5
     312:	09298993          	addi	s3,s3,146 # 53a0 <malloc+0x220>
    if(fd < 0){
  ...
  int fd = open("junk", O_CREATE|O_WRONLY);
     ...
     34e:	05650513          	addi	a0,a0,86 # 53a0 <malloc+0x220>
  ...
  if(write(fd, "x", 1) != 1){
     ...
     362:	fca58593          	addi	a1,a1,-54 # 5328 <malloc+0x1a8>
     366:	13f040ef          	jal	4ca4 <write>
     36a:	4785                	li	a5,1
     36c:	02f50d63          	beq	a0,a5,3a6 <badwrite+0xb8>
    printf("write failed\n");
     370:	00005517          	auipc	a0,0x5
     374:	05050513          	addi	a0,a0,80 # 53c0 <malloc+0x240>
     378:	555040ef          	jal	50cc <printf>
    exit(1);
     37c:	4505                	li	a0,1
     37e:	107040ef          	jal	4c84 <exit>
      printf("open junk failed\n");
     382:	00005517          	auipc	a0,0x5
     386:	02650513          	addi	a0,a0,38 # 53a8 <malloc+0x228>
     38a:	543040ef          	jal	50cc <printf>
      exit(1);
     38e:	4505                	li	a0,1
     390:	0f5040ef          	jal	4c84 <exit>
    printf("open junk failed\n");
     394:	00005517          	auipc	a0,0x5
     398:	01450513          	addi	a0,a0,20 # 53a8 <malloc+0x228>
     39c:	531040ef          	jal	50cc <printf>
    exit(1);
     3a0:	4505                	li	a0,1
  ...
  unlink("junk");
     ...
     3b0:	ff450513          	addi	a0,a0,-12 # 53a0 <malloc+0x220>
...
000000000000047e <copyin>:
{
  ...
  uint64 addrs[] = { 0x80000000LL, 0x3fffffe000, 0x3ffffff000, 0x4000000000,
     ...
     494:	27878793          	addi	a5,a5,632 # 7708 <malloc+0x2588>
     498:	638c                	ld	a1,0(a5)
     49a:	6790                	ld	a2,8(a5)
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
    ...
    int fd = open("copyin1", O_CREATE|O_WRONLY);
     ...
     4c2:	f12a0a13          	addi	s4,s4,-238 # 53d0 <malloc+0x250>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
     ...
     548:	e9450513          	addi	a0,a0,-364 # 53d8 <malloc+0x258>
     54c:	381040ef          	jal	50cc <printf>
      exit(1);
     550:	4505                	li	a0,1
     ...
     55e:	e9650513          	addi	a0,a0,-362 # 53f0 <malloc+0x270>
     562:	36b040ef          	jal	50cc <printf>
      exit(1);
     566:	4505                	li	a0,1
     ...
     574:	eb050513          	addi	a0,a0,-336 # 5420 <malloc+0x2a0>
     578:	355040ef          	jal	50cc <printf>
      exit(1);
     57c:	4505                	li	a0,1
     57e:	706040ef          	jal	4c84 <exit>
      printf("pipe() failed\n");
     582:	00005517          	auipc	a0,0x5
     586:	ece50513          	addi	a0,a0,-306 # 5450 <malloc+0x2d0>
     58a:	343040ef          	jal	50cc <printf>
      exit(1);
     58e:	4505                	li	a0,1
     ...
     59c:	ec850513          	addi	a0,a0,-312 # 5460 <malloc+0x2e0>
     5a0:	32d040ef          	jal	50cc <printf>
      exit(1);
     5a4:	4505                	li	a0,1
...
00000000000005aa <copyout>:
{
  ...
  uint64 addrs[] = { 0LL, 0x80000000LL, 0x3fffffe000, 0x3ffffff000, 0x4000000000,
     ...
     5c2:	14a78793          	addi	a5,a5,330 # 7708 <malloc+0x2588>
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
    ...
    int fd = open("README", 0);
     ...
     5f6:	e9ea0a13          	addi	s4,s4,-354 # 5490 <malloc+0x310>
    n = write(fds[1], "x", 1);
     5fa:	00005a97          	auipc	s5,0x5
     5fe:	d2ea8a93          	addi	s5,s5,-722 # 5328 <malloc+0x1a8>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
     ...
     682:	e1a50513          	addi	a0,a0,-486 # 5498 <malloc+0x318>
     686:	247040ef          	jal	50cc <printf>
      exit(1);
     68a:	4505                	li	a0,1
     ...
     698:	e1c50513          	addi	a0,a0,-484 # 54b0 <malloc+0x330>
     69c:	231040ef          	jal	50cc <printf>
      exit(1);
     6a0:	4505                	li	a0,1
     6a2:	5e2040ef          	jal	4c84 <exit>
      printf("pipe() failed\n");
     6a6:	00005517          	auipc	a0,0x5
     6aa:	daa50513          	addi	a0,a0,-598 # 5450 <malloc+0x2d0>
     6ae:	21f040ef          	jal	50cc <printf>
      exit(1);
     6b2:	4505                	li	a0,1
     6b4:	5d0040ef          	jal	4c84 <exit>
      printf("pipe write failed\n");
     6b8:	00005517          	auipc	a0,0x5
     6bc:	e2850513          	addi	a0,a0,-472 # 54e0 <malloc+0x360>
     6c0:	20d040ef          	jal	50cc <printf>
      exit(1);
     6c4:	4505                	li	a0,1
     ...
     6d2:	e2a50513          	addi	a0,a0,-470 # 54f8 <malloc+0x378>
     6d6:	1f7040ef          	jal	50cc <printf>
      exit(1);
     6da:	4505                	li	a0,1
...
00000000000006e0 <truncate1>:
{
  ...
  unlink("truncfile");
     ...
     6f8:	c1c50513          	addi	a0,a0,-996 # 5310 <malloc+0x190>
     6fc:	5d8040ef          	jal	4cd4 <unlink>
  int fd1 = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
     700:	60100593          	li	a1,1537
     704:	00005517          	auipc	a0,0x5
     708:	c0c50513          	addi	a0,a0,-1012 # 5310 <malloc+0x190>
     70c:	5b8040ef          	jal	4cc4 <open>
     710:	84aa                	mv	s1,a0
  write(fd1, "abcd", 4);
     712:	4611                	li	a2,4
     714:	00005597          	auipc	a1,0x5
     718:	c0c58593          	addi	a1,a1,-1012 # 5320 <malloc+0x1a0>
  ...
  int fd2 = open("truncfile", O_RDONLY);
     ...
     72c:	be850513          	addi	a0,a0,-1048 # 5310 <malloc+0x190>
  ...
  fd1 = open("truncfile", O_WRONLY|O_TRUNC);
     ...
     750:	bc450513          	addi	a0,a0,-1084 # 5310 <malloc+0x190>
     754:	570040ef          	jal	4cc4 <open>
     758:	89aa                	mv	s3,a0
  int fd3 = open("truncfile", O_RDONLY);
     75a:	4581                	li	a1,0
     75c:	00005517          	auipc	a0,0x5
     760:	bb450513          	addi	a0,a0,-1100 # 5310 <malloc+0x190>
  ...
  write(fd1, "abcdef", 6);
     ...
     792:	dfa58593          	addi	a1,a1,-518 # 5588 <malloc+0x408>
     796:	854e                	mv	a0,s3
  ...
  unlink("truncfile");
     ...
     7c8:	b4c50513          	addi	a0,a0,-1204 # 5310 <malloc+0x190>
  ...
  close(fd3);
    ...
    printf("%s: read %d bytes, wanted 4\n", s, n);
     ...
     7fc:	d3050513          	addi	a0,a0,-720 # 5528 <malloc+0x3a8>
     800:	0cd040ef          	jal	50cc <printf>
    exit(1);
     804:	4505                	li	a0,1
    ...
    printf("aaa fd3=%d\n", fd3);
     ...
     810:	d3c50513          	addi	a0,a0,-708 # 5548 <malloc+0x3c8>
     814:	0b9040ef          	jal	50cc <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     818:	8652                	mv	a2,s4
     81a:	85d6                	mv	a1,s5
     81c:	00005517          	auipc	a0,0x5
     820:	d3c50513          	addi	a0,a0,-708 # 5558 <malloc+0x3d8>
     824:	0a9040ef          	jal	50cc <printf>
    exit(1);
     828:	4505                	li	a0,1
    ...
    printf("bbb fd2=%d\n", fd2);
     ...
     834:	d4850513          	addi	a0,a0,-696 # 5578 <malloc+0x3f8>
     838:	095040ef          	jal	50cc <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     83c:	8652                	mv	a2,s4
     83e:	85d6                	mv	a1,s5
     840:	00005517          	auipc	a0,0x5
     844:	d1850513          	addi	a0,a0,-744 # 5558 <malloc+0x3d8>
     848:	085040ef          	jal	50cc <printf>
    exit(1);
     84c:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 6\n", s, n);
     ...
     85a:	d3a50513          	addi	a0,a0,-710 # 5590 <malloc+0x410>
     85e:	06f040ef          	jal	50cc <printf>
    exit(1);
     862:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 2\n", s, n);
     ...
     870:	d4450513          	addi	a0,a0,-700 # 55b0 <malloc+0x430>
     874:	059040ef          	jal	50cc <printf>
    exit(1);
     878:	4505                	li	a0,1
...
000000000000087e <writetest>:
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     89c:	d3850513          	addi	a0,a0,-712 # 55d0 <malloc+0x450>
  ...
  if(fd < 0){
    ...
    if(write(fd, "aaaaaaaaaa", SZ) != SZ){
     ...
     8b0:	d4c98993          	addi	s3,s3,-692 # 55f8 <malloc+0x478>
    if(write(fd, "bbbbbbbbbb", SZ) != SZ){
     8b4:	00005a97          	auipc	s5,0x5
     8b8:	d7ca8a93          	addi	s5,s5,-644 # 5630 <malloc+0x4b0>
  for(i = 0; i < N; i++){
  ...
  fd = open("small", O_RDONLY);
     ...
     8f2:	ce250513          	addi	a0,a0,-798 # 55d0 <malloc+0x450>
  ...
  if(unlink("small") < 0){
     ...
     922:	cb250513          	addi	a0,a0,-846 # 55d0 <malloc+0x450>
    ...
    printf("%s: error: creat small failed!\n", s);
     ...
     948:	c9450513          	addi	a0,a0,-876 # 55d8 <malloc+0x458>
     94c:	780040ef          	jal	50cc <printf>
    exit(1);
     950:	4505                	li	a0,1
     ...
     95e:	cae50513          	addi	a0,a0,-850 # 5608 <malloc+0x488>
     962:	76a040ef          	jal	50cc <printf>
      exit(1);
     966:	4505                	li	a0,1
     ...
     974:	cd050513          	addi	a0,a0,-816 # 5640 <malloc+0x4c0>
     978:	754040ef          	jal	50cc <printf>
      exit(1);
     97c:	4505                	li	a0,1
    ...
    printf("%s: error: open small failed!\n", s);
     ...
     988:	ce450513          	addi	a0,a0,-796 # 5668 <malloc+0x4e8>
     98c:	740040ef          	jal	50cc <printf>
    exit(1);
     990:	4505                	li	a0,1
    ...
    printf("%s: read failed\n", s);
     ...
     99c:	cf050513          	addi	a0,a0,-784 # 5688 <malloc+0x508>
     9a0:	72c040ef          	jal	50cc <printf>
    exit(1);
     9a4:	4505                	li	a0,1
    ...
    printf("%s: unlink small failed\n", s);
     ...
     9b0:	cf450513          	addi	a0,a0,-780 # 56a0 <malloc+0x520>
     9b4:	718040ef          	jal	50cc <printf>
    exit(1);
     9b8:	4505                	li	a0,1
...
00000000000009be <writebig>:
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     9da:	cea50513          	addi	a0,a0,-790 # 56c0 <malloc+0x540>
  ...
  fd = open("big", O_RDONLY);
     ...
     a20:	ca450513          	addi	a0,a0,-860 # 56c0 <malloc+0x540>
  ...
  if(fd < 0){
    ...
    printf("%s: error: creat big failed!\n", s);
     ...
     a60:	c6c50513          	addi	a0,a0,-916 # 56c8 <malloc+0x548>
     a64:	668040ef          	jal	50cc <printf>
    exit(1);
     a68:	4505                	li	a0,1
     ...
     a76:	c7650513          	addi	a0,a0,-906 # 56e8 <malloc+0x568>
     a7a:	652040ef          	jal	50cc <printf>
      exit(1);
     a7e:	4505                	li	a0,1
    ...
    printf("%s: error: open big failed!\n", s);
     ...
     a8a:	c8a50513          	addi	a0,a0,-886 # 5710 <malloc+0x590>
     a8e:	63e040ef          	jal	50cc <printf>
    exit(1);
     a92:	4505                	li	a0,1
  ...
  if(unlink("big") < 0){
     ...
     aaa:	c1a50513          	addi	a0,a0,-998 # 56c0 <malloc+0x540>
     ...
     ad0:	c6450513          	addi	a0,a0,-924 # 5730 <malloc+0x5b0>
     ad4:	5f8040ef          	jal	50cc <printf>
        exit(1);
     ad8:	4505                	li	a0,1
     ...
     ae6:	c7650513          	addi	a0,a0,-906 # 5758 <malloc+0x5d8>
     aea:	5e2040ef          	jal	50cc <printf>
      exit(1);
     aee:	4505                	li	a0,1
     ...
     afc:	c7850513          	addi	a0,a0,-904 # 5770 <malloc+0x5f0>
     b00:	5cc040ef          	jal	50cc <printf>
      exit(1);
     b04:	4505                	li	a0,1
    ...
    printf("%s: unlink big failed\n", s);
     ...
     b10:	c8c50513          	addi	a0,a0,-884 # 5798 <malloc+0x618>
     b14:	5b8040ef          	jal	50cc <printf>
    exit(1);
     b18:	4505                	li	a0,1
...
0000000000000b1e <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
     ...
     b36:	c7e50513          	addi	a0,a0,-898 # 57b0 <malloc+0x630>
  ...
  write(fd, "hello", SZ);
     ...
     b4a:	c9a58593          	addi	a1,a1,-870 # 57e0 <malloc+0x660>
  ...
  fd = open("unlinkread", O_RDWR);
     ...
     b5e:	c5650513          	addi	a0,a0,-938 # 57b0 <malloc+0x630>
  ...
  unlink("unlinkread");
     ...
     be6:	bce50513          	addi	a0,a0,-1074 # 57b0 <malloc+0x630>
    ...
    printf("%s: create unlinkread failed\n", s);
     ...
     c02:	bc250513          	addi	a0,a0,-1086 # 57c0 <malloc+0x640>
     c06:	4c6040ef          	jal	50cc <printf>
    exit(1);
     c0a:	4505                	li	a0,1
    ...
    printf("%s: open unlinkread failed\n", s);
     ...
     c16:	bd650513          	addi	a0,a0,-1066 # 57e8 <malloc+0x668>
     c1a:	4b2040ef          	jal	50cc <printf>
    exit(1);
     c1e:	4505                	li	a0,1
    ...
    printf("%s: unlink unlinkread failed\n", s);
     ...
     c2a:	be250513          	addi	a0,a0,-1054 # 5808 <malloc+0x688>
     c2e:	49e040ef          	jal	50cc <printf>
    exit(1);
     c32:	4505                	li	a0,1
    ...
    printf("%s: unlinkread read failed", s);
     ...
     c3e:	bf650513          	addi	a0,a0,-1034 # 5830 <malloc+0x6b0>
     c42:	48a040ef          	jal	50cc <printf>
    exit(1);
     c46:	4505                	li	a0,1
    ...
    printf("%s: unlinkread wrong data\n", s);
     ...
     c52:	c0250513          	addi	a0,a0,-1022 # 5850 <malloc+0x6d0>
     c56:	476040ef          	jal	50cc <printf>
    exit(1);
     c5a:	4505                	li	a0,1
    ...
    printf("%s: unlinkread write failed\n", s);
     ...
     c66:	c0e50513          	addi	a0,a0,-1010 # 5870 <malloc+0x6f0>
     c6a:	462040ef          	jal	50cc <printf>
    exit(1);
     c6e:	4505                	li	a0,1
...
0000000000000c74 <linktest>:
{
  ...
  unlink("lf1");
     ...
     c86:	c0e50513          	addi	a0,a0,-1010 # 5890 <malloc+0x710>
     c8a:	04a040ef          	jal	4cd4 <unlink>
  unlink("lf2");
     c8e:	00005517          	auipc	a0,0x5
     c92:	c0a50513          	addi	a0,a0,-1014 # 5898 <malloc+0x718>
     c96:	03e040ef          	jal	4cd4 <unlink>
  fd = open("lf1", O_CREATE|O_RDWR);
     c9a:	20200593          	li	a1,514
     c9e:	00005517          	auipc	a0,0x5
     ca2:	bf250513          	addi	a0,a0,-1038 # 5890 <malloc+0x710>
  ...
  if(write(fd, "hello", SZ) != SZ){
     ...
     cb6:	b2e58593          	addi	a1,a1,-1234 # 57e0 <malloc+0x660>
  ...
  if(link(".", "lf1") >= 0){
    ...
    printf("%s: create lf1 failed\n", s);
     ...
     d8e:	b1650513          	addi	a0,a0,-1258 # 58a0 <malloc+0x720>
     d92:	33a040ef          	jal	50cc <printf>
    exit(1);
     d96:	4505                	li	a0,1
    ...
    printf("%s: write lf1 failed\n", s);
     ...
     da2:	b1a50513          	addi	a0,a0,-1254 # 58b8 <malloc+0x738>
     da6:	326040ef          	jal	50cc <printf>
    exit(1);
     daa:	4505                	li	a0,1
    ...
    printf("%s: link lf1 lf2 failed\n", s);
     ...
     db6:	b1e50513          	addi	a0,a0,-1250 # 58d0 <malloc+0x750>
     dba:	312040ef          	jal	50cc <printf>
    exit(1);
     dbe:	4505                	li	a0,1
    ...
    printf("%s: unlinked lf1 but it is still there!\n", s);
     ...
     dca:	b2a50513          	addi	a0,a0,-1238 # 58f0 <malloc+0x770>
     dce:	2fe040ef          	jal	50cc <printf>
    exit(1);
     dd2:	4505                	li	a0,1
    ...
    printf("%s: open lf2 failed\n", s);
     ...
     dde:	b4650513          	addi	a0,a0,-1210 # 5920 <malloc+0x7a0>
     de2:	2ea040ef          	jal	50cc <printf>
    exit(1);
     de6:	4505                	li	a0,1
    ...
    printf("%s: read lf2 failed\n", s);
     ...
     df2:	b4a50513          	addi	a0,a0,-1206 # 5938 <malloc+0x7b8>
     df6:	2d6040ef          	jal	50cc <printf>
    exit(1);
     dfa:	4505                	li	a0,1
    ...
    printf("%s: link lf2 lf2 succeeded! oops\n", s);
     ...
     e06:	b4e50513          	addi	a0,a0,-1202 # 5950 <malloc+0x7d0>
     e0a:	2c2040ef          	jal	50cc <printf>
    exit(1);
     e0e:	4505                	li	a0,1
    ...
    printf("%s: link non-existent succeeded! oops\n", s);
     ...
     e1a:	b6250513          	addi	a0,a0,-1182 # 5978 <malloc+0x7f8>
     e1e:	2ae040ef          	jal	50cc <printf>
    exit(1);
     e22:	4505                	li	a0,1
    ...
    printf("%s: link . lf1 succeeded! oops\n", s);
     ...
     e2e:	b7e50513          	addi	a0,a0,-1154 # 59a8 <malloc+0x828>
     e32:	29a040ef          	jal	50cc <printf>
    exit(1);
     e36:	4505                	li	a0,1
...
0000000000000e3c <validatetest>:
{
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    if(link("nosuchfile", (char*)p) != -1){
     ...
     e58:	b7498993          	addi	s3,s3,-1164 # 59c8 <malloc+0x848>
     e5c:	597d                	li	s2,-1
  for(p = 0; p <= (uint)hi; p += PGSIZE){
     e5e:	6a85                	lui	s5,0x1
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
     ...
     e90:	b4c50513          	addi	a0,a0,-1204 # 59d8 <malloc+0x858>
     e94:	238040ef          	jal	50cc <printf>
      exit(1);
     e98:	4505                	li	a0,1
...
0000000000000e9e <bigdir>:
{
  ...
  unlink("bd");
     ...
     eb8:	b4450513          	addi	a0,a0,-1212 # 59f8 <malloc+0x878>
     ebc:	619030ef          	jal	4cd4 <unlink>
  fd = open("bd", O_CREATE);
     ec0:	20000593          	li	a1,512
     ec4:	00005517          	auipc	a0,0x5
     ec8:	b3450513          	addi	a0,a0,-1228 # 59f8 <malloc+0x878>
  ...
  for(i = 0; i < N; i++){
    ...
    if(link("bd", name) != 0){
     ...
     ee2:	b1aa0a13          	addi	s4,s4,-1254 # 59f8 <malloc+0x878>
  for(i = 0; i < N; i++){
  ...
  unlink("bd");
     ...
     f30:	acc50513          	addi	a0,a0,-1332 # 59f8 <malloc+0x878>
  ...
  for(i = 0; i < N; i++){
    ...
    printf("%s: bigdir create failed\n", s);
     ...
     f98:	a6c50513          	addi	a0,a0,-1428 # 5a00 <malloc+0x880>
     f9c:	130040ef          	jal	50cc <printf>
    exit(1);
     fa0:	4505                	li	a0,1
     ...
     fb2:	a7250513          	addi	a0,a0,-1422 # 5a20 <malloc+0x8a0>
     fb6:	116040ef          	jal	50cc <printf>
      exit(1);
     fba:	4505                	li	a0,1
     ...
     fc6:	a8650513          	addi	a0,a0,-1402 # 5a48 <malloc+0x8c8>
     fca:	102040ef          	jal	50cc <printf>
      exit(1);
     fce:	4505                	li	a0,1
...
0000000000001000 <badarg>:
{
    ...
    101e:	29e98993          	addi	s3,s3,670 # 52b8 <malloc+0x138>
    argv[0] = (char*)0xffffffff;
...
000000000000103e <copyinstr2>:
{
  ...
  char *args[] = { "xx", 0 };
    ...
    1094:	b0878793          	addi	a5,a5,-1272 # 6b98 <malloc+0x1a18>
  ...
  if(pid == 0){
    ...
    10e8:	62478793          	addi	a5,a5,1572 # 7708 <malloc+0x2588>
    ...
    110c:	1b050513          	addi	a0,a0,432 # 52b8 <malloc+0x138>
    ...
    1120:	9d450513          	addi	a0,a0,-1580 # 5af0 <malloc+0x970>
    1124:	7a9030ef          	jal	50cc <printf>
      exit(1);
    1128:	4505                	li	a0,1
    ...
    1138:	93450513          	addi	a0,a0,-1740 # 5a68 <malloc+0x8e8>
    113c:	791030ef          	jal	50cc <printf>
    exit(1);
    1140:	4505                	li	a0,1
    ...
    1150:	93c50513          	addi	a0,a0,-1732 # 5a88 <malloc+0x908>
    1154:	779030ef          	jal	50cc <printf>
    exit(1);
    1158:	4505                	li	a0,1
    ...
    116a:	94250513          	addi	a0,a0,-1726 # 5aa8 <malloc+0x928>
    116e:	75f030ef          	jal	50cc <printf>
    exit(1);
    1172:	4505                	li	a0,1
    ...
    1182:	95250513          	addi	a0,a0,-1710 # 5ad0 <malloc+0x950>
    1186:	747030ef          	jal	50cc <printf>
    exit(1);
    118a:	4505                	li	a0,1
    118c:	2f9030ef          	jal	4c84 <exit>
    printf("fork failed\n");
    1190:	00006517          	auipc	a0,0x6
    1194:	f6050513          	addi	a0,a0,-160 # 70f0 <malloc+0x1f70>
    1198:	735030ef          	jal	50cc <printf>
    exit(1);
    119c:	4505                	li	a0,1
  ...
  if(st != 747){
    ...
    11ce:	94e50513          	addi	a0,a0,-1714 # 5b18 <malloc+0x998>
    11d2:	6fb030ef          	jal	50cc <printf>
    exit(1);
    11d6:	4505                	li	a0,1
...
00000000000011dc <truncate3>:
{
  ...
  close(open("truncfile", O_CREATE|O_TRUNC|O_WRONLY));
    ...
    11f0:	12450513          	addi	a0,a0,292 # 5310 <malloc+0x190>
  ...
  if(pid == 0){
    ...
    1216:	0fea0a13          	addi	s4,s4,254 # 5310 <malloc+0x190>
      int n = write(fd, "1234567890", 10);
    121a:	00005a97          	auipc	s5,0x5
    121e:	95ea8a93          	addi	s5,s5,-1698 # 5b78 <malloc+0x9f8>
      int fd = open("truncfile", O_WRONLY);
    1222:	4585                	li	a1,1
    1224:	8552                	mv	a0,s4
    ...
    127a:	8d250513          	addi	a0,a0,-1838 # 5b48 <malloc+0x9c8>
    127e:	64f030ef          	jal	50cc <printf>
    exit(1);
    1282:	4505                	li	a0,1
    ...
    128e:	8d650513          	addi	a0,a0,-1834 # 5b60 <malloc+0x9e0>
    1292:	63b030ef          	jal	50cc <printf>
        exit(1);
    1296:	4505                	li	a0,1
    ...
    12a4:	8e850513          	addi	a0,a0,-1816 # 5b88 <malloc+0xa08>
    12a8:	625030ef          	jal	50cc <printf>
        exit(1);
    12ac:	4505                	li	a0,1
    ...
    12c2:	052a0a13          	addi	s4,s4,82 # 5310 <malloc+0x190>
    int n = write(fd, "xxx", 3);
    12c6:	00005a97          	auipc	s5,0x5
    12ca:	8e2a8a93          	addi	s5,s5,-1822 # 5ba8 <malloc+0xa28>
    int fd = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
  ...
  unlink("truncfile");
    ...
    1304:	01050513          	addi	a0,a0,16 # 5310 <malloc+0x190>
  ...
  exit(xstatus);
    ...
    131a:	84a50513          	addi	a0,a0,-1974 # 5b60 <malloc+0x9e0>
    131e:	5af030ef          	jal	50cc <printf>
      exit(1);
    1322:	4505                	li	a0,1
    ...
    1330:	88450513          	addi	a0,a0,-1916 # 5bb0 <malloc+0xa30>
    1334:	599030ef          	jal	50cc <printf>
      exit(1);
    1338:	4505                	li	a0,1
...
000000000000133e <exectest>:
{
  ...
  char *echoargv[] = { "echo", "OK", 0 };
    ...
    134e:	f6e78793          	addi	a5,a5,-146 # 52b8 <malloc+0x138>
    1352:	fcf43023          	sd	a5,-64(s0)
    1356:	00005797          	auipc	a5,0x5
    135a:	87a78793          	addi	a5,a5,-1926 # 5bd0 <malloc+0xa50>
    135e:	fcf43423          	sd	a5,-56(s0)
    1362:	fc043823          	sd	zero,-48(s0)
  unlink("echo-ok");
    1366:	00005517          	auipc	a0,0x5
    136a:	87250513          	addi	a0,a0,-1934 # 5bd8 <malloc+0xa58>
  ...
  if(pid == 0) {
    ...
    138e:	84e50513          	addi	a0,a0,-1970 # 5bd8 <malloc+0xa58>
    ...
    13a6:	85650513          	addi	a0,a0,-1962 # 5bf8 <malloc+0xa78>
    13aa:	523030ef          	jal	50cc <printf>
      exit(1);
    13ae:	4505                	li	a0,1
    ...
    13bc:	79050513          	addi	a0,a0,1936 # 5b48 <malloc+0x9c8>
    13c0:	50d030ef          	jal	50cc <printf>
     exit(1);
    13c4:	4505                	li	a0,1
    ...
    13d0:	81450513          	addi	a0,a0,-2028 # 5be0 <malloc+0xa60>
    13d4:	4f9030ef          	jal	50cc <printf>
      exit(1);
    13d8:	4505                	li	a0,1
    ...
    13e6:	ed650513          	addi	a0,a0,-298 # 52b8 <malloc+0x138>
  ...
  if(xstatus != 0)
    ...
    140e:	7fe50513          	addi	a0,a0,2046 # 5c08 <malloc+0xa88>
    1412:	4bb030ef          	jal	50cc <printf>
      exit(1);
    1416:	4505                	li	a0,1
    ...
    1422:	80250513          	addi	a0,a0,-2046 # 5c20 <malloc+0xaa0>
    1426:	4a7030ef          	jal	50cc <printf>
    142a:	bfd1                	j	13fe <exectest+0xc0>
  fd = open("echo-ok", O_RDONLY);
    142c:	4581                	li	a1,0
    142e:	00004517          	auipc	a0,0x4
    1432:	7aa50513          	addi	a0,a0,1962 # 5bd8 <malloc+0xa58>
  ...
  if (read(fd, buf, 2) != 2) {
    ...
    1454:	23850513          	addi	a0,a0,568 # 5688 <malloc+0x508>
    1458:	475030ef          	jal	50cc <printf>
    exit(1);
    145c:	4505                	li	a0,1
    ...
    1468:	6fc50513          	addi	a0,a0,1788 # 5b60 <malloc+0x9e0>
    146c:	461030ef          	jal	50cc <printf>
    exit(1);
    1470:	4505                	li	a0,1
    1472:	013030ef          	jal	4c84 <exit>
  unlink("echo-ok");
    1476:	00004517          	auipc	a0,0x4
    147a:	76250513          	addi	a0,a0,1890 # 5bd8 <malloc+0xa58>
  ...
  if(buf[0] == 'O' && buf[1] == 'K')
    ...
    14a0:	79c50513          	addi	a0,a0,1948 # 5c38 <malloc+0xab8>
    14a4:	429030ef          	jal	50cc <printf>
    exit(1);
    14a8:	4505                	li	a0,1
...
00000000000014b4 <pipe1>:
{
  ...
  if(pid == 0){
    ...
    154c:	70850513          	addi	a0,a0,1800 # 5c50 <malloc+0xad0>
    1550:	37d030ef          	jal	50cc <printf>
    exit(1);
    1554:	4505                	li	a0,1
    ...
    1582:	42da8a93          	addi	s5,s5,1069 # 142d <exectest+0xef>
{
    ...
    15c6:	6a650513          	addi	a0,a0,1702 # 5c68 <malloc+0xae8>
    15ca:	303030ef          	jal	50cc <printf>
        exit(1);
    15ce:	4505                	li	a0,1
    ...
    15da:	6aa50513          	addi	a0,a0,1706 # 5c80 <malloc+0xb00>
    15de:	2ef030ef          	jal	50cc <printf>
          return;
    ...
    160a:	69250513          	addi	a0,a0,1682 # 5c98 <malloc+0xb18>
    160e:	2bf030ef          	jal	50cc <printf>
      exit(1);
    1612:	4505                	li	a0,1
    ...
    1642:	67a50513          	addi	a0,a0,1658 # 5cb8 <malloc+0xb38>
    1646:	287030ef          	jal	50cc <printf>
    exit(1);
    164a:	4505                	li	a0,1
...
0000000000001650 <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
    ...
    16a4:	4a850513          	addi	a0,a0,1192 # 5b48 <malloc+0x9c8>
    16a8:	225030ef          	jal	50cc <printf>
      exit(1);
    16ac:	4505                	li	a0,1
    ...
    16b8:	61c50513          	addi	a0,a0,1564 # 5cd0 <malloc+0xb50>
    16bc:	211030ef          	jal	50cc <printf>
        exit(1);
    16c0:	4505                	li	a0,1
    ...
    16cc:	62050513          	addi	a0,a0,1568 # 5ce8 <malloc+0xb68>
    16d0:	1fd030ef          	jal	50cc <printf>
        exit(1);
    16d4:	4505                	li	a0,1
...
00000000000016e0 <twochildren>:
{
  ...
  for(int i = 0; i < 1000; i++){
    ...
    1728:	42450513          	addi	a0,a0,1060 # 5b48 <malloc+0x9c8>
    172c:	1a1030ef          	jal	50cc <printf>
      exit(1);
    1730:	4505                	li	a0,1
    ...
    1740:	40c50513          	addi	a0,a0,1036 # 5b48 <malloc+0x9c8>
    1744:	189030ef          	jal	50cc <printf>
        exit(1);
    1748:	4505                	li	a0,1
...
0000000000001752 <forkfork>:
{
    ...
    179e:	56e50513          	addi	a0,a0,1390 # 5d08 <malloc+0xb88>
    17a2:	12b030ef          	jal	50cc <printf>
      exit(1);
    17a6:	4505                	li	a0,1
    17a8:	4dc030ef          	jal	4c84 <exit>
{
    ...
    17da:	54250513          	addi	a0,a0,1346 # 5d18 <malloc+0xb98>
    17de:	0ef030ef          	jal	50cc <printf>
      exit(1);
    17e2:	4505                	li	a0,1
...
00000000000017e8 <reparent2>:
{
  ...
  exit(0);
    ...
    1814:	8e050513          	addi	a0,a0,-1824 # 70f0 <malloc+0x1f70>
    1818:	0b5030ef          	jal	50cc <printf>
      exit(1);
    181c:	4505                	li	a0,1
...
0000000000001830 <createdelete>:
{
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    1896:	2b650513          	addi	a0,a0,694 # 5b48 <malloc+0x9c8>
    189a:	033030ef          	jal	50cc <printf>
      exit(1);
    189e:	4505                	li	a0,1
    ...
    18ba:	32a50513          	addi	a0,a0,810 # 5be0 <malloc+0xa60>
    18be:	00f030ef          	jal	50cc <printf>
          exit(1);
    18c2:	4505                	li	a0,1
    ...
    1918:	42450513          	addi	a0,a0,1060 # 5d38 <malloc+0xbb8>
    191c:	7b0030ef          	jal	50cc <printf>
            exit(1);
    1920:	4505                	li	a0,1
    ...
    193c:	41850513          	addi	a0,a0,1048 # 5d50 <malloc+0xbd0>
    1940:	78c030ef          	jal	50cc <printf>
        exit(1);
    1944:	4505                	li	a0,1
    ...
    198e:	3ee50513          	addi	a0,a0,1006 # 5d78 <malloc+0xbf8>
    1992:	73a030ef          	jal	50cc <printf>
        exit(1);
    1996:	4505                	li	a0,1
...
0000000000001a08 <linkunlink>:
{
  ...
  unlink("x");
    ...
    1a28:	90450513          	addi	a0,a0,-1788 # 5328 <malloc+0x1a8>
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1a5c:	8d0b0b13          	addi	s6,s6,-1840 # 5328 <malloc+0x1a8>
      link("cat", "x");
    1a60:	00004c17          	auipc	s8,0x4
    1a64:	340c0c13          	addi	s8,s8,832 # 5da0 <malloc+0xc20>
    1a68:	a025                	j	1a90 <linkunlink+0x88>
    printf("%s: fork failed\n", s);
    1a6a:	85a6                	mv	a1,s1
    1a6c:	00004517          	auipc	a0,0x4
    1a70:	0dc50513          	addi	a0,a0,220 # 5b48 <malloc+0x9c8>
    1a74:	658030ef          	jal	50cc <printf>
    exit(1);
    1a78:	4505                	li	a0,1
...
0000000000001ae4 <forktest>:
{
  ...
  for(n=0; n<N; n++){
    ...
    1b10:	2e450513          	addi	a0,a0,740 # 5df0 <malloc+0xc70>
    1b14:	5b8030ef          	jal	50cc <printf>
    exit(1);
    1b18:	4505                	li	a0,1
    ...
    1b28:	28450513          	addi	a0,a0,644 # 5da8 <malloc+0xc28>
    1b2c:	5a0030ef          	jal	50cc <printf>
    exit(1);
    1b30:	4505                	li	a0,1
    ...
    1b3c:	28850513          	addi	a0,a0,648 # 5dc0 <malloc+0xc40>
    1b40:	58c030ef          	jal	50cc <printf>
      exit(1);
    1b44:	4505                	li	a0,1
    ...
    1b50:	28c50513          	addi	a0,a0,652 # 5dd8 <malloc+0xc58>
    1b54:	578030ef          	jal	50cc <printf>
    exit(1);
    1b58:	4505                	li	a0,1
...
0000000000001b8c <kernmem>:
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    1bee:	f5e50513          	addi	a0,a0,-162 # 5b48 <malloc+0x9c8>
    1bf2:	4da030ef          	jal	50cc <printf>
      exit(1);
    1bf6:	4505                	li	a0,1
    ...
    1c08:	21450513          	addi	a0,a0,532 # 5e18 <malloc+0xc98>
    1c0c:	4c0030ef          	jal	50cc <printf>
      exit(1);
    1c10:	4505                	li	a0,1
...
0000000000001c1c <MAXVAplus>:
{
  ...
  for( ; a != 0; a <<= 1){
    ...
    1c76:	ed650513          	addi	a0,a0,-298 # 5b48 <malloc+0x9c8>
    1c7a:	452030ef          	jal	50cc <printf>
      exit(1);
    1c7e:	4505                	li	a0,1
    ...
    1c9a:	1a250513          	addi	a0,a0,418 # 5e38 <malloc+0xcb8>
    1c9e:	42e030ef          	jal	50cc <printf>
      exit(1);
    1ca2:	4505                	li	a0,1
...
r_sp()
{
  ...
  asm volatile("mv %0, sp" : "=r" (x) );
    ...
    1cea:	16a50513          	addi	a0,a0,362 # 5e50 <malloc+0xcd0>
    1cee:	3de030ef          	jal	50cc <printf>
    exit(1);
    1cf2:	4505                	li	a0,1
    ...
    1cfe:	e4e50513          	addi	a0,a0,-434 # 5b48 <malloc+0x9c8>
    1d02:	3ca030ef          	jal	50cc <printf>
    exit(1);
    1d06:	4505                	li	a0,1
...
0000000000001d12 <nowrite>:
{
  ...
  uint64 addrs[] = { 0, 0x80000000LL, 0x3fffffe000, 0x3ffffff000, 0x4000000000,
    ...
    1d26:	9e678793          	addi	a5,a5,-1562 # 7708 <malloc+0x2588>
  ...
  exit(0);
    ...
    1d8e:	0ee50513          	addi	a0,a0,238 # 5e78 <malloc+0xcf8>
    1d92:	33a030ef          	jal	50cc <printf>
      exit(0);
    1d96:	4501                	li	a0,0
    ...
    1da2:	daa50513          	addi	a0,a0,-598 # 5b48 <malloc+0x9c8>
    1da6:	326030ef          	jal	50cc <printf>
      exit(1);
    1daa:	4505                	li	a0,1
...
0000000000001db6 <manywrites>:
{
  ...
  exit(0);
    ...
    1e0e:	2e650513          	addi	a0,a0,742 # 70f0 <malloc+0x1f70>
    1e12:	2ba030ef          	jal	50cc <printf>
      exit(1);
    1e16:	4505                	li	a0,1
    ...
    1ea0:	ffc50513          	addi	a0,a0,-4 # 5e98 <malloc+0xd18>
    1ea4:	228030ef          	jal	50cc <printf>
            exit(1);
    1ea8:	4505                	li	a0,1
    ...
    1eb8:	4d450513          	addi	a0,a0,1236 # 5388 <malloc+0x208>
    1ebc:	210030ef          	jal	50cc <printf>
            exit(1);
    1ec0:	4505                	li	a0,1
...
0000000000001eca <copyinstr3>:
{
  ...
  *b = 'x';
  ...
  char *args[] = { "xx", 0 };
    ...
    1f2c:	c7078793          	addi	a5,a5,-912 # 6b98 <malloc+0x1a18>
  ...
  if(ret != -1){
    ...
    1f66:	f4e50513          	addi	a0,a0,-178 # 5eb0 <malloc+0xd30>
    1f6a:	162030ef          	jal	50cc <printf>
    exit(1);
    1f6e:	4505                	li	a0,1
    ...
    1f7c:	af050513          	addi	a0,a0,-1296 # 5a68 <malloc+0x8e8>
    1f80:	14c030ef          	jal	50cc <printf>
    exit(1);
    1f84:	4505                	li	a0,1
    ...
    1f92:	afa50513          	addi	a0,a0,-1286 # 5a88 <malloc+0x908>
    1f96:	136030ef          	jal	50cc <printf>
    exit(1);
    1f9a:	4505                	li	a0,1
    ...
    1faa:	b0250513          	addi	a0,a0,-1278 # 5aa8 <malloc+0x928>
    1fae:	11e030ef          	jal	50cc <printf>
    exit(1);
    1fb2:	4505                	li	a0,1
    ...
    1fc0:	b1450513          	addi	a0,a0,-1260 # 5ad0 <malloc+0x950>
    1fc4:	108030ef          	jal	50cc <printf>
    exit(1);
    1fc8:	4505                	li	a0,1
...
0000000000001fce <rwsbrk>:
{
  ...
  fd = open("rwsbrk", O_CREATE|O_WRONLY);
    ...
    1ffc:	ef850513          	addi	a0,a0,-264 # 5ef0 <malloc+0xd70>
  ...
  if(n >= 0){
    ...
    2024:	ef050513          	addi	a0,a0,-272 # 5f10 <malloc+0xd90>
    2028:	0a4030ef          	jal	50cc <printf>
    exit(1);
    202c:	4505                	li	a0,1
    ...
    203a:	e8250513          	addi	a0,a0,-382 # 5eb8 <malloc+0xd38>
    203e:	08e030ef          	jal	50cc <printf>
    exit(1);
    2042:	4505                	li	a0,1
    ...
    204e:	e8650513          	addi	a0,a0,-378 # 5ed0 <malloc+0xd50>
    2052:	07a030ef          	jal	50cc <printf>
    exit(1);
    2056:	4505                	li	a0,1
    2058:	42d020ef          	jal	4c84 <exit>
    printf("open(rwsbrk) failed\n");
    205c:	00004517          	auipc	a0,0x4
    2060:	e9c50513          	addi	a0,a0,-356 # 5ef8 <malloc+0xd78>
    2064:	068030ef          	jal	50cc <printf>
    exit(1);
    2068:	4505                	li	a0,1
  ...
  unlink("rwsbrk");
    ...
    2078:	e7c50513          	addi	a0,a0,-388 # 5ef0 <malloc+0xd70>
    207c:	459020ef          	jal	4cd4 <unlink>
  fd = open("README", O_RDONLY);
    2080:	4581                	li	a1,0
    2082:	00003517          	auipc	a0,0x3
    2086:	40e50513          	addi	a0,a0,1038 # 5490 <malloc+0x310>
  ...
  if(n >= 0){
    ...
    20a8:	e9c50513          	addi	a0,a0,-356 # 5f40 <malloc+0xdc0>
    20ac:	020030ef          	jal	50cc <printf>
    exit(1);
    20b0:	4505                	li	a0,1
    20b2:	3d3020ef          	jal	4c84 <exit>
    printf("open(README) failed\n");
    20b6:	00003517          	auipc	a0,0x3
    20ba:	3e250513          	addi	a0,a0,994 # 5498 <malloc+0x318>
    20be:	00e030ef          	jal	50cc <printf>
    exit(1);
    20c2:	4505                	li	a0,1
...
00000000000020d4 <sbrkbasic>:
{
  ...
  if(pid == 0){
    ...
    2124:	e4850513          	addi	a0,a0,-440 # 5f68 <malloc+0xde8>
    2128:	7a5020ef          	jal	50cc <printf>
    exit(1);
    212c:	4505                	li	a0,1
  ...
  for(i = 0; i < 5000; i++){
    ...
    2174:	e1850513          	addi	a0,a0,-488 # 5f88 <malloc+0xe08>
    2178:	755020ef          	jal	50cc <printf>
    exit(1);
    217c:	4505                	li	a0,1
  ...
  if(c != a + 1){
    ...
    21c0:	e2c50513          	addi	a0,a0,-468 # 5fe8 <malloc+0xe68>
    21c4:	709020ef          	jal	50cc <printf>
    exit(1);
    21c8:	4505                	li	a0,1
    ...
    21da:	dd250513          	addi	a0,a0,-558 # 5fa8 <malloc+0xe28>
    21de:	6ef020ef          	jal	50cc <printf>
      exit(1);
    21e2:	4505                	li	a0,1
    ...
    21ee:	dde50513          	addi	a0,a0,-546 # 5fc8 <malloc+0xe48>
    21f2:	6db020ef          	jal	50cc <printf>
    exit(1);
    21f6:	4505                	li	a0,1
...
0000000000002216 <sbrkmuch>:
{
  ...
  *lastaddr = 99;
  ...
  if(c != a){
    ...
    22d6:	d3650513          	addi	a0,a0,-714 # 6008 <malloc+0xe88>
    22da:	5f3020ef          	jal	50cc <printf>
    exit(1);
    22de:	4505                	li	a0,1
    ...
    22ea:	d6a50513          	addi	a0,a0,-662 # 6050 <malloc+0xed0>
    22ee:	5df020ef          	jal	50cc <printf>
    exit(1);
    22f2:	4505                	li	a0,1
    ...
    2302:	d7250513          	addi	a0,a0,-654 # 6070 <malloc+0xef0>
    2306:	5c7020ef          	jal	50cc <printf>
    exit(1);
    230a:	4505                	li	a0,1
    ...
    231a:	d9a50513          	addi	a0,a0,-614 # 60b0 <malloc+0xf30>
    231e:	5af020ef          	jal	50cc <printf>
    exit(1);
    2322:	4505                	li	a0,1
    ...
    232e:	db650513          	addi	a0,a0,-586 # 60e0 <malloc+0xf60>
    2332:	59b020ef          	jal	50cc <printf>
    exit(1);
    2336:	4505                	li	a0,1
    ...
    2346:	dd650513          	addi	a0,a0,-554 # 6118 <malloc+0xf98>
    234a:	583020ef          	jal	50cc <printf>
    exit(1);
    234e:	4505                	li	a0,1
...
0000000000002354 <sbrkarg>:
{
  ...
  fd = open("sbrk", O_CREATE|O_WRONLY);
    ...
    2374:	dd050513          	addi	a0,a0,-560 # 6140 <malloc+0xfc0>
    2378:	14d020ef          	jal	4cc4 <open>
    237c:	84aa                	mv	s1,a0
  unlink("sbrk");
    237e:	00004517          	auipc	a0,0x4
    2382:	dc250513          	addi	a0,a0,-574 # 6140 <malloc+0xfc0>
  ...
  if(pipe((int *) a) != 0){
    ...
    23c2:	d8a50513          	addi	a0,a0,-630 # 6148 <malloc+0xfc8>
    23c6:	507020ef          	jal	50cc <printf>
    exit(1);
    23ca:	4505                	li	a0,1
    ...
    23d6:	d8e50513          	addi	a0,a0,-626 # 6160 <malloc+0xfe0>
    23da:	4f3020ef          	jal	50cc <printf>
    exit(1);
    23de:	4505                	li	a0,1
    ...
    23ea:	86a50513          	addi	a0,a0,-1942 # 5c50 <malloc+0xad0>
    23ee:	4df020ef          	jal	50cc <printf>
    exit(1);
    23f2:	4505                	li	a0,1
...
00000000000023f8 <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    240c:	d7050513          	addi	a0,a0,-656 # 6178 <malloc+0xff8>
  ...
  close(fd);
    ...
    2444:	72050513          	addi	a0,a0,1824 # 5b60 <malloc+0x9e0>
    2448:	485020ef          	jal	50cc <printf>
    exit(1);
    244c:	4505                	li	a0,1
...
0000000000002452 <sbrkbugs>:
{
  ...
  if(pid == 0){
    ...
    247a:	c7a50513          	addi	a0,a0,-902 # 70f0 <malloc+0x1f70>
    247e:	44f020ef          	jal	50cc <printf>
    exit(1);
    2482:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    24b4:	c4050513          	addi	a0,a0,-960 # 70f0 <malloc+0x1f70>
    24b8:	415020ef          	jal	50cc <printf>
    exit(1);
    24bc:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    24f4:	c0050513          	addi	a0,a0,-1024 # 70f0 <malloc+0x1f70>
    24f8:	3d5020ef          	jal	50cc <printf>
    exit(1);
    24fc:	4505                	li	a0,1
...
00000000000025de <execout>:
{
  ...
  exit(0);
    ...
    2614:	ae050513          	addi	a0,a0,-1312 # 70f0 <malloc+0x1f70>
    2618:	2b5020ef          	jal	50cc <printf>
      exit(1);
    261c:	4505                	li	a0,1
    ...
    2654:	c6850513          	addi	a0,a0,-920 # 52b8 <malloc+0x138>
    2658:	faa43c23          	sd	a0,-72(s0)
    265c:	00003797          	auipc	a5,0x3
    2660:	ccc78793          	addi	a5,a5,-820 # 5328 <malloc+0x1a8>
...
000000000000267a <fourteen>:
{
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    26aa:	b5a50513          	addi	a0,a0,-1190 # 6200 <malloc+0x1080>
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    26c0:	bbc50513          	addi	a0,a0,-1092 # 6278 <malloc+0x10f8>
  ...
  unlink("12345678901234");
    ...
    2744:	a4050513          	addi	a0,a0,-1472 # 6180 <malloc+0x1000>
    2748:	185020ef          	jal	50cc <printf>
    exit(1);
    274c:	4505                	li	a0,1
    ...
    2758:	a7450513          	addi	a0,a0,-1420 # 61c8 <malloc+0x1048>
    275c:	171020ef          	jal	50cc <printf>
    exit(1);
    2760:	4505                	li	a0,1
    ...
    276c:	ac850513          	addi	a0,a0,-1336 # 6230 <malloc+0x10b0>
    2770:	15d020ef          	jal	50cc <printf>
    exit(1);
    2774:	4505                	li	a0,1
    ...
    2780:	b2c50513          	addi	a0,a0,-1236 # 62a8 <malloc+0x1128>
    2784:	149020ef          	jal	50cc <printf>
    exit(1);
    2788:	4505                	li	a0,1
    ...
    2794:	b7850513          	addi	a0,a0,-1160 # 6308 <malloc+0x1188>
    2798:	135020ef          	jal	50cc <printf>
    exit(1);
    279c:	4505                	li	a0,1
    ...
    27a8:	bbc50513          	addi	a0,a0,-1092 # 6360 <malloc+0x11e0>
    27ac:	121020ef          	jal	50cc <printf>
    exit(1);
    27b0:	4505                	li	a0,1
...
00000000000027b6 <diskfull>:
{
  ...
  unlink("diskfulldir");
    ...
    27f0:	bac50513          	addi	a0,a0,-1108 # 6398 <malloc+0x1218>
  ...
  for(fi = 0; done == 0 && '0' + fi < 0177; fi++){
    ...
    281c:	b9050513          	addi	a0,a0,-1136 # 63a8 <malloc+0x1228>
    2820:	0ad020ef          	jal	50cc <printf>
      break;
  ...
  if(mkdir("diskfulldir") == 0)
    ...
    2892:	b0a50513          	addi	a0,a0,-1270 # 6398 <malloc+0x1218>
    2896:	456020ef          	jal	4cec <mkdir>
    289a:	12050063          	beqz	a0,29ba <diskfull+0x204>
  unlink("diskfulldir");
    289e:	00004517          	auipc	a0,0x4
    28a2:	afa50513          	addi	a0,a0,-1286 # 6398 <malloc+0x1218>
  ...
  for(fi = 0; done == 0 && '0' + fi < 0177; fi++){
    ...
    29c0:	a0c50513          	addi	a0,a0,-1524 # 63c8 <malloc+0x1248>
    29c4:	708020ef          	jal	50cc <printf>
...
00000000000029ca <iputtest>:
{
  ...
  if(chdir("/") < 0){
    ...
    2a26:	9de50513          	addi	a0,a0,-1570 # 6400 <malloc+0x1280>
    2a2a:	6a2020ef          	jal	50cc <printf>
    exit(1);
    2a2e:	4505                	li	a0,1
    ...
    2a3a:	9e250513          	addi	a0,a0,-1566 # 6418 <malloc+0x1298>
    2a3e:	68e020ef          	jal	50cc <printf>
    exit(1);
    2a42:	4505                	li	a0,1
    ...
    2a4e:	9fe50513          	addi	a0,a0,-1538 # 6448 <malloc+0x12c8>
    2a52:	67a020ef          	jal	50cc <printf>
    exit(1);
    2a56:	4505                	li	a0,1
    ...
    2a62:	a1250513          	addi	a0,a0,-1518 # 6470 <malloc+0x12f0>
    2a66:	666020ef          	jal	50cc <printf>
    exit(1);
    2a6a:	4505                	li	a0,1
...
0000000000002a70 <exitiputtest>:
{
  ...
  if(pid == 0){
    ...
    2ac2:	08a50513          	addi	a0,a0,138 # 5b48 <malloc+0x9c8>
    2ac6:	606020ef          	jal	50cc <printf>
    exit(1);
    2aca:	4505                	li	a0,1
    ...
    2ad6:	92e50513          	addi	a0,a0,-1746 # 6400 <malloc+0x1280>
    2ada:	5f2020ef          	jal	50cc <printf>
      exit(1);
    2ade:	4505                	li	a0,1
    ...
    2aea:	9a250513          	addi	a0,a0,-1630 # 6488 <malloc+0x1308>
    2aee:	5de020ef          	jal	50cc <printf>
      exit(1);
    2af2:	4505                	li	a0,1
    ...
    2afe:	94e50513          	addi	a0,a0,-1714 # 6448 <malloc+0x12c8>
    2b02:	5ca020ef          	jal	50cc <printf>
      exit(1);
    2b06:	4505                	li	a0,1
...
0000000000002b1c <dirtest>:
{
  ...
  if(unlink("dir0") < 0){
    ...
    2b78:	88c50513          	addi	a0,a0,-1908 # 6400 <malloc+0x1280>
    2b7c:	550020ef          	jal	50cc <printf>
    exit(1);
    2b80:	4505                	li	a0,1
    ...
    2b8c:	92050513          	addi	a0,a0,-1760 # 64a8 <malloc+0x1328>
    2b90:	53c020ef          	jal	50cc <printf>
    exit(1);
    2b94:	4505                	li	a0,1
    ...
    2ba0:	92c50513          	addi	a0,a0,-1748 # 64c8 <malloc+0x1348>
    2ba4:	528020ef          	jal	50cc <printf>
    exit(1);
    2ba8:	4505                	li	a0,1
    ...
    2bb4:	93050513          	addi	a0,a0,-1744 # 64e0 <malloc+0x1360>
    2bb8:	514020ef          	jal	50cc <printf>
    exit(1);
    2bbc:	4505                	li	a0,1
...
0000000000002bc2 <subdir>:
{
  ...
  unlink("ff");
    ...
    2bd4:	a5850513          	addi	a0,a0,-1448 # 6628 <malloc+0x14a8>
    2bd8:	0fc020ef          	jal	4cd4 <unlink>
  if(mkdir("dd") != 0){
    2bdc:	00004517          	auipc	a0,0x4
    2be0:	91c50513          	addi	a0,a0,-1764 # 64f8 <malloc+0x1378>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    2bf4:	92850513          	addi	a0,a0,-1752 # 6518 <malloc+0x1398>
  ...
  write(fd, "ff", 2);
    ...
    2c08:	a2458593          	addi	a1,a1,-1500 # 6628 <malloc+0x14a8>
  ...
  if(unlink("dd") >= 0){
    ...
    2c1a:	8e250513          	addi	a0,a0,-1822 # 64f8 <malloc+0x1378>
    2c1e:	0b6020ef          	jal	4cd4 <unlink>
    2c22:	2c055963          	bgez	a0,2ef4 <subdir+0x332>
  if(mkdir("/dd/dd") != 0){
    2c26:	00004517          	auipc	a0,0x4
    2c2a:	94a50513          	addi	a0,a0,-1718 # 6570 <malloc+0x13f0>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    2c3e:	95e50513          	addi	a0,a0,-1698 # 6598 <malloc+0x1418>
  ...
  write(fd, "FF", 2);
    ...
    2c52:	97a58593          	addi	a1,a1,-1670 # 65c8 <malloc+0x1448>
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    2c66:	96e50513          	addi	a0,a0,-1682 # 65d0 <malloc+0x1450>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    2d4c:	85050513          	addi	a0,a0,-1968 # 6598 <malloc+0x1418>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    2d60:	a5450513          	addi	a0,a0,-1452 # 67b0 <malloc+0x1630>
  ...
  if(unlink("dd") < 0){
    ...
    2ed2:	63250513          	addi	a0,a0,1586 # 6500 <malloc+0x1380>
    2ed6:	1f6020ef          	jal	50cc <printf>
    exit(1);
    2eda:	4505                	li	a0,1
    ...
    2ee6:	63e50513          	addi	a0,a0,1598 # 6520 <malloc+0x13a0>
    2eea:	1e2020ef          	jal	50cc <printf>
    exit(1);
    2eee:	4505                	li	a0,1
    ...
    2efa:	64a50513          	addi	a0,a0,1610 # 6540 <malloc+0x13c0>
    2efe:	1ce020ef          	jal	50cc <printf>
    exit(1);
    2f02:	4505                	li	a0,1
    ...
    2f0e:	66e50513          	addi	a0,a0,1646 # 6578 <malloc+0x13f8>
    2f12:	1ba020ef          	jal	50cc <printf>
    exit(1);
    2f16:	4505                	li	a0,1
    ...
    2f22:	68a50513          	addi	a0,a0,1674 # 65a8 <malloc+0x1428>
    2f26:	1a6020ef          	jal	50cc <printf>
    exit(1);
    2f2a:	4505                	li	a0,1
    ...
    2f36:	6ae50513          	addi	a0,a0,1710 # 65e0 <malloc+0x1460>
    2f3a:	192020ef          	jal	50cc <printf>
    exit(1);
    2f3e:	4505                	li	a0,1
    ...
    2f4a:	6ba50513          	addi	a0,a0,1722 # 6600 <malloc+0x1480>
    2f4e:	17e020ef          	jal	50cc <printf>
    exit(1);
    2f52:	4505                	li	a0,1
    ...
    2f5e:	6d650513          	addi	a0,a0,1750 # 6630 <malloc+0x14b0>
    2f62:	16a020ef          	jal	50cc <printf>
    exit(1);
    2f66:	4505                	li	a0,1
    ...
    2f72:	6ea50513          	addi	a0,a0,1770 # 6658 <malloc+0x14d8>
    2f76:	156020ef          	jal	50cc <printf>
    exit(1);
    2f7a:	4505                	li	a0,1
    ...
    2f86:	6f650513          	addi	a0,a0,1782 # 6678 <malloc+0x14f8>
    2f8a:	142020ef          	jal	50cc <printf>
    exit(1);
    2f8e:	4505                	li	a0,1
    ...
    2f9a:	70a50513          	addi	a0,a0,1802 # 66a0 <malloc+0x1520>
    2f9e:	12e020ef          	jal	50cc <printf>
    exit(1);
    2fa2:	4505                	li	a0,1
    ...
    2fae:	71e50513          	addi	a0,a0,1822 # 66c8 <malloc+0x1548>
    2fb2:	11a020ef          	jal	50cc <printf>
    exit(1);
    2fb6:	4505                	li	a0,1
    ...
    2fc2:	73a50513          	addi	a0,a0,1850 # 66f8 <malloc+0x1578>
    2fc6:	106020ef          	jal	50cc <printf>
    exit(1);
    2fca:	4505                	li	a0,1
    ...
    2fd6:	75650513          	addi	a0,a0,1878 # 6728 <malloc+0x15a8>
    2fda:	0f2020ef          	jal	50cc <printf>
    exit(1);
    2fde:	4505                	li	a0,1
    ...
    2fea:	75a50513          	addi	a0,a0,1882 # 6740 <malloc+0x15c0>
    2fee:	0de020ef          	jal	50cc <printf>
    exit(1);
    2ff2:	4505                	li	a0,1
    ...
    2ffe:	76650513          	addi	a0,a0,1894 # 6760 <malloc+0x15e0>
    3002:	0ca020ef          	jal	50cc <printf>
    exit(1);
    3006:	4505                	li	a0,1
    ...
    3012:	77250513          	addi	a0,a0,1906 # 6780 <malloc+0x1600>
    3016:	0b6020ef          	jal	50cc <printf>
    exit(1);
    301a:	4505                	li	a0,1
    ...
    3026:	79e50513          	addi	a0,a0,1950 # 67c0 <malloc+0x1640>
    302a:	0a2020ef          	jal	50cc <printf>
    exit(1);
    302e:	4505                	li	a0,1
    ...
    303a:	7ba50513          	addi	a0,a0,1978 # 67f0 <malloc+0x1670>
    303e:	08e020ef          	jal	50cc <printf>
    exit(1);
    3042:	4505                	li	a0,1
    ...
    304e:	7c650513          	addi	a0,a0,1990 # 6810 <malloc+0x1690>
    3052:	07a020ef          	jal	50cc <printf>
    exit(1);
    3056:	4505                	li	a0,1
    ...
    3062:	7d250513          	addi	a0,a0,2002 # 6830 <malloc+0x16b0>
    3066:	066020ef          	jal	50cc <printf>
    exit(1);
    306a:	4505                	li	a0,1
    ...
    3076:	7de50513          	addi	a0,a0,2014 # 6850 <malloc+0x16d0>
    307a:	052020ef          	jal	50cc <printf>
    exit(1);
    307e:	4505                	li	a0,1
    ...
    308a:	7fa50513          	addi	a0,a0,2042 # 6880 <malloc+0x1700>
    308e:	03e020ef          	jal	50cc <printf>
    exit(1);
    3092:	4505                	li	a0,1
    ...
    309e:	80e50513          	addi	a0,a0,-2034 # 68a8 <malloc+0x1728>
    30a2:	02a020ef          	jal	50cc <printf>
    exit(1);
    30a6:	4505                	li	a0,1
    ...
    30b2:	82250513          	addi	a0,a0,-2014 # 68d0 <malloc+0x1750>
    30b6:	016020ef          	jal	50cc <printf>
    exit(1);
    30ba:	4505                	li	a0,1
    ...
    30c6:	83650513          	addi	a0,a0,-1994 # 68f8 <malloc+0x1778>
    30ca:	002020ef          	jal	50cc <printf>
    exit(1);
    30ce:	4505                	li	a0,1
    ...
    30da:	84250513          	addi	a0,a0,-1982 # 6918 <malloc+0x1798>
    30de:	7ef010ef          	jal	50cc <printf>
    exit(1);
    30e2:	4505                	li	a0,1
    ...
    30ee:	84e50513          	addi	a0,a0,-1970 # 6938 <malloc+0x17b8>
    30f2:	7db010ef          	jal	50cc <printf>
    exit(1);
    30f6:	4505                	li	a0,1
    ...
    3102:	86250513          	addi	a0,a0,-1950 # 6960 <malloc+0x17e0>
    3106:	7c7010ef          	jal	50cc <printf>
    exit(1);
    310a:	4505                	li	a0,1
    ...
    3116:	86e50513          	addi	a0,a0,-1938 # 6980 <malloc+0x1800>
    311a:	7b3010ef          	jal	50cc <printf>
    exit(1);
    311e:	4505                	li	a0,1
    ...
    312a:	87a50513          	addi	a0,a0,-1926 # 69a0 <malloc+0x1820>
    312e:	79f010ef          	jal	50cc <printf>
    exit(1);
    3132:	4505                	li	a0,1
    ...
    313e:	88e50513          	addi	a0,a0,-1906 # 69c8 <malloc+0x1848>
    3142:	78b010ef          	jal	50cc <printf>
    exit(1);
    3146:	4505                	li	a0,1
    ...
    3152:	50a50513          	addi	a0,a0,1290 # 6658 <malloc+0x14d8>
    3156:	777010ef          	jal	50cc <printf>
    exit(1);
    315a:	4505                	li	a0,1
    ...
    3166:	88650513          	addi	a0,a0,-1914 # 69e8 <malloc+0x1868>
    316a:	763010ef          	jal	50cc <printf>
    exit(1);
    316e:	4505                	li	a0,1
    ...
    317a:	89250513          	addi	a0,a0,-1902 # 6a08 <malloc+0x1888>
    317e:	74f010ef          	jal	50cc <printf>
    exit(1);
    3182:	4505                	li	a0,1
    ...
    318e:	8ae50513          	addi	a0,a0,-1874 # 6a38 <malloc+0x18b8>
    3192:	73b010ef          	jal	50cc <printf>
    exit(1);
    3196:	4505                	li	a0,1
    ...
    31a2:	8ba50513          	addi	a0,a0,-1862 # 6a58 <malloc+0x18d8>
    31a6:	727010ef          	jal	50cc <printf>
    exit(1);
    31aa:	4505                	li	a0,1
...
00000000000031b0 <rmdot>:
{
  ...
  if(unlink("dots") != 0){
    ...
    323c:	84050513          	addi	a0,a0,-1984 # 6a78 <malloc+0x18f8>
    3240:	68d010ef          	jal	50cc <printf>
    exit(1);
    3244:	4505                	li	a0,1
    ...
    3250:	84450513          	addi	a0,a0,-1980 # 6a90 <malloc+0x1910>
    3254:	679010ef          	jal	50cc <printf>
    exit(1);
    3258:	4505                	li	a0,1
    ...
    3264:	84850513          	addi	a0,a0,-1976 # 6aa8 <malloc+0x1928>
    3268:	665010ef          	jal	50cc <printf>
    exit(1);
    326c:	4505                	li	a0,1
    ...
    3278:	84c50513          	addi	a0,a0,-1972 # 6ac0 <malloc+0x1940>
    327c:	651010ef          	jal	50cc <printf>
    exit(1);
    3280:	4505                	li	a0,1
    ...
    328c:	1e850513          	addi	a0,a0,488 # 6470 <malloc+0x12f0>
    3290:	63d010ef          	jal	50cc <printf>
    exit(1);
    3294:	4505                	li	a0,1
    ...
    32a0:	84450513          	addi	a0,a0,-1980 # 6ae0 <malloc+0x1960>
    32a4:	629010ef          	jal	50cc <printf>
    exit(1);
    32a8:	4505                	li	a0,1
    ...
    32b4:	85850513          	addi	a0,a0,-1960 # 6b08 <malloc+0x1988>
    32b8:	615010ef          	jal	50cc <printf>
    exit(1);
    32bc:	4505                	li	a0,1
    ...
    32c8:	86450513          	addi	a0,a0,-1948 # 6b28 <malloc+0x19a8>
    32cc:	601010ef          	jal	50cc <printf>
    exit(1);
    32d0:	4505                	li	a0,1
...
00000000000032d6 <dirfile>:
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    32ec:	86050513          	addi	a0,a0,-1952 # 6b48 <malloc+0x19c8>
  ...
  if(chdir("dirfile") == 0){
    ...
    3300:	84c50513          	addi	a0,a0,-1972 # 6b48 <malloc+0x19c8>
    3304:	1f1010ef          	jal	4cf4 <chdir>
    3308:	c569                	beqz	a0,33d2 <dirfile+0xfc>
  fd = open("dirfile/xx", 0);
    330a:	4581                	li	a1,0
    330c:	00004517          	auipc	a0,0x4
    3310:	88450513          	addi	a0,a0,-1916 # 6b90 <malloc+0x1a10>
  ...
  fd = open(".", 0);
    ...
    3390:	61450513          	addi	a0,a0,1556 # 59a0 <malloc+0x820>
    3394:	131010ef          	jal	4cc4 <open>
    3398:	84aa                	mv	s1,a0
  if(write(fd, "x", 1) > 0){
    339a:	4605                	li	a2,1
    339c:	00002597          	auipc	a1,0x2
    33a0:	f8c58593          	addi	a1,a1,-116 # 5328 <malloc+0x1a8>
  ...
  close(fd);
    ...
    33c4:	79050513          	addi	a0,a0,1936 # 6b50 <malloc+0x19d0>
    33c8:	505010ef          	jal	50cc <printf>
    exit(1);
    33cc:	4505                	li	a0,1
    ...
    33d8:	79c50513          	addi	a0,a0,1948 # 6b70 <malloc+0x19f0>
    33dc:	4f1010ef          	jal	50cc <printf>
    exit(1);
    33e0:	4505                	li	a0,1
    ...
    33ec:	7b850513          	addi	a0,a0,1976 # 6ba0 <malloc+0x1a20>
    33f0:	4dd010ef          	jal	50cc <printf>
    exit(1);
    33f4:	4505                	li	a0,1
    ...
    3400:	7a450513          	addi	a0,a0,1956 # 6ba0 <malloc+0x1a20>
    3404:	4c9010ef          	jal	50cc <printf>
    exit(1);
    3408:	4505                	li	a0,1
    ...
    3414:	7b850513          	addi	a0,a0,1976 # 6bc8 <malloc+0x1a48>
    3418:	4b5010ef          	jal	50cc <printf>
    exit(1);
    341c:	4505                	li	a0,1
    ...
    3428:	7cc50513          	addi	a0,a0,1996 # 6bf0 <malloc+0x1a70>
    342c:	4a1010ef          	jal	50cc <printf>
    exit(1);
    3430:	4505                	li	a0,1
    ...
    343c:	7e050513          	addi	a0,a0,2016 # 6c18 <malloc+0x1a98>
    3440:	48d010ef          	jal	50cc <printf>
    exit(1);
    3444:	4505                	li	a0,1
    ...
    3450:	7f450513          	addi	a0,a0,2036 # 6c40 <malloc+0x1ac0>
    3454:	479010ef          	jal	50cc <printf>
    exit(1);
    3458:	4505                	li	a0,1
    ...
    3464:	80050513          	addi	a0,a0,-2048 # 6c60 <malloc+0x1ae0>
    3468:	465010ef          	jal	50cc <printf>
    exit(1);
    346c:	4505                	li	a0,1
    ...
    3478:	81450513          	addi	a0,a0,-2028 # 6c88 <malloc+0x1b08>
    347c:	451010ef          	jal	50cc <printf>
    exit(1);
    3480:	4505                	li	a0,1
...
0000000000003486 <iref>:
{
    ...
    34a4:	800a0a13          	addi	s4,s4,-2048 # 6ca0 <malloc+0x1b20>
    mkdir("");
    34a8:	00003497          	auipc	s1,0x3
    34ac:	30048493          	addi	s1,s1,768 # 67a8 <malloc+0x1628>
    link("README", "");
    34b0:	00002a97          	auipc	s5,0x2
    34b4:	fe0a8a93          	addi	s5,s5,-32 # 5490 <malloc+0x310>
    fd = open("xx", O_CREATE);
    34b8:	00003997          	auipc	s3,0x3
    34bc:	6e098993          	addi	s3,s3,1760 # 6b98 <malloc+0x1a18>
    34c0:	a835                	j	34fc <iref+0x76>
      printf("%s: mkdir irefd failed\n", s);
    34c2:	85da                	mv	a1,s6
    34c4:	00003517          	auipc	a0,0x3
    34c8:	7e450513          	addi	a0,a0,2020 # 6ca8 <malloc+0x1b28>
    34cc:	401010ef          	jal	50cc <printf>
      exit(1);
    34d0:	4505                	li	a0,1
    ...
    34dc:	7e850513          	addi	a0,a0,2024 # 6cc0 <malloc+0x1b40>
    34e0:	3ed010ef          	jal	50cc <printf>
      exit(1);
    34e4:	4505                	li	a0,1
  ...
  for(i = 0; i < NINODE + 1; i++){
    ...
    3544:	f8098993          	addi	s3,s3,-128 # 64c0 <malloc+0x1340>
    unlink("irefd");
    3548:	00003917          	auipc	s2,0x3
    354c:	75890913          	addi	s2,s2,1880 # 6ca0 <malloc+0x1b20>
    chdir("..");
    3550:	854e                	mv	a0,s3
  ...
  chdir("/");
    ...
    3564:	f0850513          	addi	a0,a0,-248 # 6468 <malloc+0x12e8>
...
0000000000003580 <openiputtest>:
{
  ...
  if(mkdir("oidir") < 0){
    ...
    3590:	74c50513          	addi	a0,a0,1868 # 6cd8 <malloc+0x1b58>
  ...
  if(pid == 0){
    ...
    35ac:	73050513          	addi	a0,a0,1840 # 6cd8 <malloc+0x1b58>
    ...
    35be:	73e50513          	addi	a0,a0,1854 # 6cf8 <malloc+0x1b78>
    35c2:	30b010ef          	jal	50cc <printf>
      exit(1);
    35c6:	4505                	li	a0,1
    ...
    35d2:	71250513          	addi	a0,a0,1810 # 6ce0 <malloc+0x1b60>
    35d6:	2f7010ef          	jal	50cc <printf>
    exit(1);
    35da:	4505                	li	a0,1
    ...
    35e6:	56650513          	addi	a0,a0,1382 # 5b48 <malloc+0x9c8>
    35ea:	2e3010ef          	jal	50cc <printf>
    exit(1);
    35ee:	4505                	li	a0,1
  ...
  if(unlink("oidir") != 0){
    ...
    3604:	6d850513          	addi	a0,a0,1752 # 6cd8 <malloc+0x1b58>
    3608:	6cc010ef          	jal	4cd4 <unlink>
    360c:	c919                	beqz	a0,3622 <openiputtest+0xa2>
    printf("%s: unlink failed\n", s);
    360e:	85a6                	mv	a1,s1
    3610:	00002517          	auipc	a0,0x2
    3614:	72850513          	addi	a0,a0,1832 # 5d38 <malloc+0xbb8>
    3618:	2b5010ef          	jal	50cc <printf>
    exit(1);
    361c:	4505                	li	a0,1
...
0000000000003632 <forkforkfork>:
{
  ...
  unlink("stopforking");
    ...
    3642:	6e250513          	addi	a0,a0,1762 # 6d20 <malloc+0x1ba0>
  ...
  close(open("stopforking", O_CREATE|O_RDWR));
    ...
    3662:	6c250513          	addi	a0,a0,1730 # 6d20 <malloc+0x1ba0>
  ...
  pause(10); // one second
    ...
    368a:	68250513          	addi	a0,a0,1666 # 5d08 <malloc+0xb88>
    368e:	23f010ef          	jal	50cc <printf>
    exit(1);
    3692:	4505                	li	a0,1
    3694:	5f0010ef          	jal	4c84 <exit>
      int fd = open("stopforking", 0);
    3698:	00003497          	auipc	s1,0x3
    369c:	68848493          	addi	s1,s1,1672 # 6d20 <malloc+0x1ba0>
    36a0:	4581                	li	a1,0
    36a2:	8526                	mv	a0,s1
    ...
    36bc:	66850513          	addi	a0,a0,1640 # 6d20 <malloc+0x1ba0>
...
00000000000036d0 <killstatus>:
{
  ...
  exit(0);
    ...
    3722:	42a50513          	addi	a0,a0,1066 # 5b48 <malloc+0x9c8>
    3726:	1a7010ef          	jal	50cc <printf>
      exit(1);
    372a:	4505                	li	a0,1
    ...
    373c:	5f850513          	addi	a0,a0,1528 # 6d30 <malloc+0x1bb0>
    3740:	18d010ef          	jal	50cc <printf>
       exit(1);
    3744:	4505                	li	a0,1
...
000000000000374a <preempt>:
{
  ...
  if(pid1 == 0)
    ...
    3770:	59c50513          	addi	a0,a0,1436 # 5d08 <malloc+0xb88>
    3774:	159010ef          	jal	50cc <printf>
    exit(1);
    3778:	4505                	li	a0,1
  ...
  if(pid2 == 0)
    ...
    3792:	3ba50513          	addi	a0,a0,954 # 5b48 <malloc+0x9c8>
    3796:	137010ef          	jal	50cc <printf>
    exit(1);
    379a:	4505                	li	a0,1
  ...
  if(pid3 == 0){
    ...
    37c2:	b6a58593          	addi	a1,a1,-1174 # 5328 <malloc+0x1a8>
    ...
    37e4:	36850513          	addi	a0,a0,872 # 5b48 <malloc+0x9c8>
    37e8:	0e5010ef          	jal	50cc <printf>
     exit(1);
    37ec:	4505                	li	a0,1
    ...
    37f8:	55c50513          	addi	a0,a0,1372 # 6d50 <malloc+0x1bd0>
    37fc:	0d1010ef          	jal	50cc <printf>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    3828:	54450513          	addi	a0,a0,1348 # 6d68 <malloc+0x1be8>
    382c:	0a1010ef          	jal	50cc <printf>
}
  ...
  printf("kill... ");
    ...
    384c:	53850513          	addi	a0,a0,1336 # 6d80 <malloc+0x1c00>
    3850:	07d010ef          	jal	50cc <printf>
  kill(pid1);
    3854:	8526                	mv	a0,s1
  ...
  printf("wait... ");
    ...
    386a:	52a50513          	addi	a0,a0,1322 # 6d90 <malloc+0x1c10>
    386e:	05f010ef          	jal	50cc <printf>
  wait(0);
    3872:	4501                	li	a0,0
...
0000000000003886 <reparent>:
{
  ...
  exit(0);
    ...
    38ca:	28250513          	addi	a0,a0,642 # 5b48 <malloc+0x9c8>
    38ce:	7fe010ef          	jal	50cc <printf>
      exit(1);
    38d2:	4505                	li	a0,1
    ...
    38de:	3f650513          	addi	a0,a0,1014 # 5cd0 <malloc+0xb50>
    38e2:	7ea010ef          	jal	50cc <printf>
        exit(1);
    38e6:	4505                	li	a0,1
...
0000000000003906 <sbrkfail>:
{
  ...
  if(pipe(fds) != 0){
    ...
    3942:	31250513          	addi	a0,a0,786 # 5c50 <malloc+0xad0>
    3946:	786010ef          	jal	50cc <printf>
    exit(1);
    394a:	4505                	li	a0,1
    ...
    396c:	ac858593          	addi	a1,a1,-1336 # 7430 <malloc+0x22b0>
    ...
    3988:	41c58593          	addi	a1,a1,1052 # 6da0 <malloc+0x1c20>
  ...
  c = sbrk(PGSIZE);
    ...
    39da:	3d250513          	addi	a0,a0,978 # 6da8 <malloc+0x1c28>
    39de:	6ee010ef          	jal	50cc <printf>
  ...
  if(pid == 0){
    ...
    3a24:	3d850513          	addi	a0,a0,984 # 6df8 <malloc+0x1c78>
    3a28:	6a4010ef          	jal	50cc <printf>
    exit(1);
    3a2c:	4505                	li	a0,1
    ...
    3a38:	3a450513          	addi	a0,a0,932 # 6dd8 <malloc+0x1c58>
    3a3c:	690010ef          	jal	50cc <printf>
    exit(1);
    3a40:	4505                	li	a0,1
    ...
    3a4c:	10050513          	addi	a0,a0,256 # 5b48 <malloc+0x9c8>
    3a50:	67c010ef          	jal	50cc <printf>
    exit(1);
    3a54:	4505                	li	a0,1
...
0000000000003a8a <mem>:
{
  ...
  if((pid = fork()) == 0){
    ...
    3ace:	6084                	ld	s1,0(s1)
      free(m1);
    3ad0:	62e010ef          	jal	50fe <free>
    while(m1){
    3ad4:	fce5                	bnez	s1,3acc <mem+0x42>
    m1 = malloc(1024*20);
    3ad6:	6515                	lui	a0,0x5
    3ad8:	6a8010ef          	jal	5180 <malloc>
    if(m1 == 0){
    3adc:	c511                	beqz	a0,3ae8 <mem+0x5e>
    free(m1);
    3ade:	620010ef          	jal	50fe <free>
    exit(0);
    3ae2:	4501                	li	a0,0
    ...
    3aee:	33e50513          	addi	a0,a0,830 # 6e28 <malloc+0x1ca8>
    3af2:	5da010ef          	jal	50cc <printf>
      exit(1);
    3af6:	4505                	li	a0,1
...
0000000000003b02 <sharedfd>:
{
  ...
  unlink("sharedfd");
    ...
    3b12:	33a50513          	addi	a0,a0,826 # 6e48 <malloc+0x1cc8>
    3b16:	1be010ef          	jal	4cd4 <unlink>
  fd = open("sharedfd", O_CREATE|O_RDWR);
    3b1a:	20200593          	li	a1,514
    3b1e:	00003517          	auipc	a0,0x3
    3b22:	32a50513          	addi	a0,a0,810 # 6e48 <malloc+0x1cc8>
  ...
  if(pid == 0) {
    ...
    3b8c:	2d050513          	addi	a0,a0,720 # 6e58 <malloc+0x1cd8>
    3b90:	53c010ef          	jal	50cc <printf>
    exit(1);
    3b94:	4505                	li	a0,1
    ...
    3ba0:	2e450513          	addi	a0,a0,740 # 6e80 <malloc+0x1d00>
    3ba4:	528010ef          	jal	50cc <printf>
      exit(1);
    3ba8:	4505                	li	a0,1
  ...
  fd = open("sharedfd", 0);
    ...
    3bd0:	27c50513          	addi	a0,a0,636 # 6e48 <malloc+0x1cc8>
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    3c08:	29c50513          	addi	a0,a0,668 # 6ea0 <malloc+0x1d20>
    3c0c:	4c0010ef          	jal	50cc <printf>
    exit(1);
    3c10:	4505                	li	a0,1
  ...
  unlink("sharedfd");
    ...
    3c38:	21450513          	addi	a0,a0,532 # 6e48 <malloc+0x1cc8>
  ...
  if(nc == N*SZ && np == N*SZ){
    ...
    3c5a:	27250513          	addi	a0,a0,626 # 6ec8 <malloc+0x1d48>
    3c5e:	46e010ef          	jal	50cc <printf>
    exit(1);
    3c62:	4505                	li	a0,1
...
0000000000003c6e <fourfiles>:
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    ...
    3c92:	25278793          	addi	a5,a5,594 # 6ee0 <malloc+0x1d60>
    3c96:	f6f43823          	sd	a5,-144(s0)
    3c9a:	00003797          	auipc	a5,0x3
    3c9e:	24e78793          	addi	a5,a5,590 # 6ee8 <malloc+0x1d68>
    3ca2:	f6f43c23          	sd	a5,-136(s0)
    3ca6:	00003797          	auipc	a5,0x3
    3caa:	24a78793          	addi	a5,a5,586 # 6ef0 <malloc+0x1d70>
    3cae:	f8f43023          	sd	a5,-128(s0)
    3cb2:	00003797          	auipc	a5,0x3
    3cb6:	24678793          	addi	a5,a5,582 # 6ef8 <malloc+0x1d78>
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    3d18:	e3450513          	addi	a0,a0,-460 # 5b48 <malloc+0x9c8>
    3d1c:	3b0010ef          	jal	50cc <printf>
      exit(1);
    3d20:	4505                	li	a0,1
    ...
    3d7a:	e6a50513          	addi	a0,a0,-406 # 5be0 <malloc+0xa60>
    3d7e:	34e010ef          	jal	50cc <printf>
        exit(1);
    3d82:	4505                	li	a0,1
    3d84:	701000ef          	jal	4c84 <exit>
          printf("write failed %d\n", n);
    3d88:	00003517          	auipc	a0,0x3
    3d8c:	17850513          	addi	a0,a0,376 # 6f00 <malloc+0x1d80>
    3d90:	33c010ef          	jal	50cc <printf>
          exit(1);
    3d94:	4505                	li	a0,1
    ...
    3da6:	17650513          	addi	a0,a0,374 # 6f18 <malloc+0x1d98>
    3daa:	322010ef          	jal	50cc <printf>
          exit(1);
    3dae:	4505                	li	a0,1
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    3e16:	11650513          	addi	a0,a0,278 # 6f28 <malloc+0x1da8>
    3e1a:	2b2010ef          	jal	50cc <printf>
      exit(1);
    3e1e:	4505                	li	a0,1
...
0000000000003e42 <concreate>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    3e70:	0d4b8b93          	addi	s7,s7,212 # 6f40 <malloc+0x1dc0>
  for(i = 0; i < N; i++){
    ...
    3eaa:	0a250513          	addi	a0,a0,162 # 6f48 <malloc+0x1dc8>
    3eae:	21e010ef          	jal	50cc <printf>
        exit(1);
    3eb2:	4505                	li	a0,1
    ...
    3ec0:	08450513          	addi	a0,a0,132 # 6f40 <malloc+0x1dc0>
  ...
  fd = open(".", 0);
    ...
    3ee8:	abc50513          	addi	a0,a0,-1348 # 59a0 <malloc+0x820>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    3f58:	01450513          	addi	a0,a0,20 # 6f68 <malloc+0x1de8>
    3f5c:	170010ef          	jal	50cc <printf>
        exit(1);
    3f60:	4505                	li	a0,1
    ...
    3f70:	01c50513          	addi	a0,a0,28 # 6f88 <malloc+0x1e08>
    3f74:	158010ef          	jal	50cc <printf>
        exit(1);
    3f78:	4505                	li	a0,1
  ...
  for(i = 0; i < N; i++){
    ...
    3f9c:	01850513          	addi	a0,a0,24 # 6fb0 <malloc+0x1e30>
    3fa0:	12c010ef          	jal	50cc <printf>
    exit(1);
    3fa4:	4505                	li	a0,1
    ...
    3fb0:	b9c50513          	addi	a0,a0,-1124 # 5b48 <malloc+0x9c8>
    3fb4:	118010ef          	jal	50cc <printf>
      exit(1);
    3fb8:	4505                	li	a0,1
...
00000000000040e6 <bigfile>:
{
  ...
  unlink("bigfile.dat");
    ...
    40fe:	eee50513          	addi	a0,a0,-274 # 6fe8 <malloc+0x1e68>
    4102:	3d3000ef          	jal	4cd4 <unlink>
  fd = open("bigfile.dat", O_CREATE | O_RDWR);
    4106:	20200593          	li	a1,514
    410a:	00003517          	auipc	a0,0x3
    410e:	ede50513          	addi	a0,a0,-290 # 6fe8 <malloc+0x1e68>
  ...
  fd = open("bigfile.dat", 0);
    ...
    415a:	e9250513          	addi	a0,a0,-366 # 6fe8 <malloc+0x1e68>
  ...
  for(i = 0; ; i++){
    ...
    41b6:	e4650513          	addi	a0,a0,-442 # 6ff8 <malloc+0x1e78>
    41ba:	713000ef          	jal	50cc <printf>
    exit(1);
    41be:	4505                	li	a0,1
    ...
    41ca:	e5250513          	addi	a0,a0,-430 # 7018 <malloc+0x1e98>
    41ce:	6ff000ef          	jal	50cc <printf>
      exit(1);
    41d2:	4505                	li	a0,1
    ...
    41de:	e5e50513          	addi	a0,a0,-418 # 7038 <malloc+0x1eb8>
    41e2:	6eb000ef          	jal	50cc <printf>
    exit(1);
    41e6:	4505                	li	a0,1
    ...
    41f2:	e6a50513          	addi	a0,a0,-406 # 7058 <malloc+0x1ed8>
    41f6:	6d7000ef          	jal	50cc <printf>
      exit(1);
    41fa:	4505                	li	a0,1
    ...
    4206:	e7650513          	addi	a0,a0,-394 # 7078 <malloc+0x1ef8>
    420a:	6c3000ef          	jal	50cc <printf>
      exit(1);
    420e:	4505                	li	a0,1
    ...
    421a:	e7a50513          	addi	a0,a0,-390 # 7090 <malloc+0x1f10>
    421e:	6af000ef          	jal	50cc <printf>
      exit(1);
    4222:	4505                	li	a0,1
  ...
  unlink("bigfile.dat");
    ...
    423c:	db050513          	addi	a0,a0,-592 # 6fe8 <malloc+0x1e68>
    ...
    425c:	e5850513          	addi	a0,a0,-424 # 70b0 <malloc+0x1f30>
    4260:	66d000ef          	jal	50cc <printf>
    exit(1);
    4264:	4505                	li	a0,1
...
000000000000426a <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    427a:	e5a50513          	addi	a0,a0,-422 # 70d0 <malloc+0x1f50>
  ...
  fd = open("bigarg-ok", 0);
    ...
    42a0:	e3450513          	addi	a0,a0,-460 # 70d0 <malloc+0x1f50>
  ...
  close(fd);
    ...
    42fa:	fc250513          	addi	a0,a0,-62 # 52b8 <malloc+0x138>
    42fe:	1bf000ef          	jal	4cbc <exec>
    fd = open("bigarg-ok", O_CREATE);
    4302:	20000593          	li	a1,512
    4306:	00003517          	auipc	a0,0x3
    430a:	dca50513          	addi	a0,a0,-566 # 70d0 <malloc+0x1f50>
    ...
    4322:	dc250513          	addi	a0,a0,-574 # 70e0 <malloc+0x1f60>
    4326:	5a7000ef          	jal	50cc <printf>
    exit(1);
    432a:	4505                	li	a0,1
    ...
    433a:	dca50513          	addi	a0,a0,-566 # 7100 <malloc+0x1f80>
    433e:	58f000ef          	jal	50cc <printf>
    exit(1);
    4342:	4505                	li	a0,1
...
0000000000004348 <lazy_alloc>:
{
  ...
  exit(0);
    ...
    4392:	d9250513          	addi	a0,a0,-622 # 7120 <malloc+0x1fa0>
    4396:	537000ef          	jal	50cc <printf>
    exit(1);
    439a:	4505                	li	a0,1
    439c:	0e9000ef          	jal	4c84 <exit>
      printf("failed to read value from memory\n");
    43a0:	00003517          	auipc	a0,0x3
    43a4:	d9850513          	addi	a0,a0,-616 # 7138 <malloc+0x1fb8>
    43a8:	525000ef          	jal	50cc <printf>
      exit(1);
    43ac:	4505                	li	a0,1
...
00000000000043b2 <lazy_unmap>:
{
  ...
  exit(0);
    ...
    441a:	d0a50513          	addi	a0,a0,-758 # 7120 <malloc+0x1fa0>
    441e:	4af000ef          	jal	50cc <printf>
    exit(1);
    4422:	4505                	li	a0,1
    4424:	061000ef          	jal	4c84 <exit>
      printf("error forking\n");
    4428:	00003517          	auipc	a0,0x3
    442c:	d3850513          	addi	a0,a0,-712 # 7160 <malloc+0x1fe0>
    4430:	49d000ef          	jal	50cc <printf>
      exit(1);
    4434:	4505                	li	a0,1
    ...
    4450:	d2450513          	addi	a0,a0,-732 # 7170 <malloc+0x1ff0>
    4454:	479000ef          	jal	50cc <printf>
        exit(1);
    4458:	4505                	li	a0,1
...
000000000000445e <lazy_copy>:
{
    ...
    44a6:	ce650513          	addi	a0,a0,-794 # 7188 <malloc+0x2008>
    44aa:	423000ef          	jal	50cc <printf>
      exit(1);
    44ae:	4505                	li	a0,1
    44b0:	7d4000ef          	jal	4c84 <exit>
  unsigned long bad[] = {
    44b4:	00003797          	auipc	a5,0x3
    44b8:	25478793          	addi	a5,a5,596 # 7708 <malloc+0x2588>
  ...
  for(int i = 0; i < sizeof(bad)/sizeof(bad[0]); i++){
    ...
    44ec:	fa8a0a13          	addi	s4,s4,-88 # 5490 <malloc+0x310>
    fd = open("junk", O_CREATE|O_RDWR|O_TRUNC);
    44f0:	00001a97          	auipc	s5,0x1
    44f4:	eb0a8a93          	addi	s5,s5,-336 # 53a0 <malloc+0x220>
    int fd = open("README", 0);
    44f8:	4581                	li	a1,0
    44fa:	8552                	mv	a0,s4
  ...
  exit(0);
    ...
    4552:	c6a50513          	addi	a0,a0,-918 # 71b8 <malloc+0x2038>
    4556:	377000ef          	jal	50cc <printf>
    455a:	4505                	li	a0,1
    455c:	728000ef          	jal	4c84 <exit>
    if(read(fd, (char*)bad[i], 512) >= 0) { printf("read succeeded\n");  exit(1); }
    4560:	00003517          	auipc	a0,0x3
    4564:	c7050513          	addi	a0,a0,-912 # 71d0 <malloc+0x2050>
    4568:	365000ef          	jal	50cc <printf>
    456c:	4505                	li	a0,1
    456e:	716000ef          	jal	4c84 <exit>
    if(fd < 0) { printf("cannot open junk\n"); exit(1); }
    4572:	00003517          	auipc	a0,0x3
    4576:	c6e50513          	addi	a0,a0,-914 # 71e0 <malloc+0x2060>
    457a:	353000ef          	jal	50cc <printf>
    457e:	4505                	li	a0,1
    4580:	704000ef          	jal	4c84 <exit>
    if(write(fd, (char*)bad[i], 512) >= 0) { printf("write succeeded\n"); exit(1); }
    4584:	00003517          	auipc	a0,0x3
    4588:	c7450513          	addi	a0,a0,-908 # 71f8 <malloc+0x2078>
    458c:	341000ef          	jal	50cc <printf>
    4590:	4505                	li	a0,1
...
0000000000004596 <fsfull>:
{
  ...
  printf("fsfull test\n");
    ...
    45b6:	c5e50513          	addi	a0,a0,-930 # 7210 <malloc+0x2090>
    45ba:	313000ef          	jal	50cc <printf>
  for(nfiles = 0; ; nfiles++){
    45be:	4481                	li	s1,0
    name[0] = 'f';
    ...
    45d2:	c52c8c93          	addi	s9,s9,-942 # 7220 <malloc+0x20a0>
    name[0] = 'f';
    ...
    463a:	bfa50513          	addi	a0,a0,-1030 # 7230 <malloc+0x20b0>
    463e:	28f000ef          	jal	50cc <printf>
  while(nfiles >= 0){
  ...
  printf("fsfull test finished\n");
    ...
    46a8:	bac50513          	addi	a0,a0,-1108 # 7250 <malloc+0x20d0>
    46ac:	221000ef          	jal	50cc <printf>
}
    ...
    46f6:	b4e50513          	addi	a0,a0,-1202 # 7240 <malloc+0x20c0>
    46fa:	1d3000ef          	jal	50cc <printf>
    close(fd);
    46fe:	854a                	mv	a0,s2
...
run(void f(char *), char *s) {
  ...
  printf("test %s: ", s);
    ...
    4720:	b4c50513          	addi	a0,a0,-1204 # 7268 <malloc+0x20e8>
    4724:	1a9000ef          	jal	50cc <printf>
  if((pid = fork()) < 0) {
  ...
  if(pid == 0) {
    ...
    4744:	b5050513          	addi	a0,a0,-1200 # 7290 <malloc+0x2110>
    4748:	185000ef          	jal	50cc <printf>
    else
      printf("OK\n");
    return xstatus == 0;
    ...
    4764:	b1850513          	addi	a0,a0,-1256 # 7278 <malloc+0x20f8>
    4768:	165000ef          	jal	50cc <printf>
    exit(1);
    476c:	4505                	li	a0,1
    ...
    4780:	b1c50513          	addi	a0,a0,-1252 # 7298 <malloc+0x2118>
    4784:	149000ef          	jal	50cc <printf>
...
runtests(struct test *tests, char *justone, int continuous) {
  ...
  for (struct test *t = tests; t->s != 0; t++) {
    ...
    47d2:	ad250513          	addi	a0,a0,-1326 # 72a0 <malloc+0x2120>
    47d6:	0f7000ef          	jal	50cc <printf>
          return -1;
    47da:	59fd                	li	s3,-1
...
drivetests(int quick, int continuous, char *justone) {
  ...
  do {
    ...
    486a:	a52c0c13          	addi	s8,s8,-1454 # 72b8 <malloc+0x2138>
    int free0 = countfree();
    int free1 = 0;
    int ntests = 0;
    int n;
    ...
    4884:	a50d8d93          	addi	s11,s11,-1456 # 72d0 <malloc+0x2150>
      } else {
        ntests += n;
      }
    }
    ...
    488c:	a68d0d13          	addi	s10,s10,-1432 # 72f0 <malloc+0x2170>
    ...
    4906:	a1e50513          	addi	a0,a0,-1506 # 7320 <malloc+0x21a0>
    490a:	7c2000ef          	jal	50cc <printf>
      return 1;
    490e:	4505                	li	a0,1
...
main(int argc, char *argv[])
{
  ...
  if(argc == 2 && strcmp(argv[1], "-q") == 0){
    ...
    4970:	9cc58593          	addi	a1,a1,-1588 # 7338 <malloc+0x21b8>
  ...
  int continuous = 0;
    ...
    49c4:	98850513          	addi	a0,a0,-1656 # 7348 <malloc+0x21c8>
    49c8:	704000ef          	jal	50cc <printf>
    exit(1);
    49cc:	4505                	li	a0,1
  ...
  printf("ALL TESTS PASSED\n");
    ...
    49e2:	99a50513          	addi	a0,a0,-1638 # 7378 <malloc+0x21f8>
    49e6:	6e6000ef          	jal	50cc <printf>
  exit(0);
    49ea:	4501                	li	a0,0
...
putc(int fd, char c)
{
    4d44:	1101                	addi	sp,sp,-32
    4d46:	ec06                	sd	ra,24(sp)
    4d48:	e822                	sd	s0,16(sp)
    4d4a:	1000                	addi	s0,sp,32
    4d4c:	feb407a3          	sb	a1,-17(s0)
  write(fd, &c, 1);
    4d50:	4605                	li	a2,1
    4d52:	fef40593          	addi	a1,s0,-17
    4d56:	f4fff0ef          	jal	4ca4 <write>
}
    4d5a:	60e2                	ld	ra,24(sp)
    4d5c:	6442                	ld	s0,16(sp)
    4d5e:	6105                	addi	sp,sp,32
    4d60:	8082                	ret

0000000000004d62 <printint>:

static void
printint(int fd, long long xx, int base, int sgn)
{
    4d62:	715d                	addi	sp,sp,-80
    4d64:	e486                	sd	ra,72(sp)
    4d66:	e0a2                	sd	s0,64(sp)
    4d68:	f84a                	sd	s2,48(sp)
    4d6a:	0880                	addi	s0,sp,80
    4d6c:	892a                	mv	s2,a0
  char buf[20];
  int i, neg;
  ...
  neg = 0;
  if(sgn && xx < 0){
    4d6e:	c299                	beqz	a3,4d74 <printint+0x12>
    4d70:	0805c363          	bltz	a1,4df6 <printint+0x94>
  neg = 0;
    4d74:	4881                	li	a7,0
    4d76:	fb840693          	addi	a3,s0,-72
    x = -xx;
  } else {
    x = xx;
  }
  ...
  do{
    ...
    4d80:	a3450513          	addi	a0,a0,-1484 # 77b0 <digits>
    4d84:	883e                	mv	a6,a5
    4d86:	2785                	addiw	a5,a5,1
    4d88:	02c5f733          	remu	a4,a1,a2
    4d8c:	972a                	add	a4,a4,a0
    4d8e:	00074703          	lbu	a4,0(a4)
    4d92:	00e68023          	sb	a4,0(a3)
  }while((x /= base) != 0);
    4d96:	872e                	mv	a4,a1
    4d98:	02c5d5b3          	divu	a1,a1,a2
    4d9c:	0685                	addi	a3,a3,1
    4d9e:	fec773e3          	bgeu	a4,a2,4d84 <printint+0x22>
  if(neg)
    4da2:	00088b63          	beqz	a7,4db8 <printint+0x56>
    buf[i++] = '-';
    4da6:	fd078793          	addi	a5,a5,-48
    4daa:	97a2                	add	a5,a5,s0
    4dac:	02d00713          	li	a4,45
    4db0:	fee78423          	sb	a4,-24(a5)
    4db4:	0028079b          	addiw	a5,a6,2

  while(--i >= 0)
    4db8:	02f05a63          	blez	a5,4dec <printint+0x8a>
    4dbc:	fc26                	sd	s1,56(sp)
    4dbe:	f44e                	sd	s3,40(sp)
    4dc0:	fb840713          	addi	a4,s0,-72
    4dc4:	00f704b3          	add	s1,a4,a5
    4dc8:	fff70993          	addi	s3,a4,-1
    4dcc:	99be                	add	s3,s3,a5
    4dce:	37fd                	addiw	a5,a5,-1
    4dd0:	1782                	slli	a5,a5,0x20
    4dd2:	9381                	srli	a5,a5,0x20
    4dd4:	40f989b3          	sub	s3,s3,a5
    putc(fd, buf[i]);
    4dd8:	fff4c583          	lbu	a1,-1(s1)
    4ddc:	854a                	mv	a0,s2
    4dde:	f67ff0ef          	jal	4d44 <putc>
  while(--i >= 0)
    4de2:	14fd                	addi	s1,s1,-1
    4de4:	ff349ae3          	bne	s1,s3,4dd8 <printint+0x76>
    4de8:	74e2                	ld	s1,56(sp)
    4dea:	79a2                	ld	s3,40(sp)
}
    4dec:	60a6                	ld	ra,72(sp)
    4dee:	6406                	ld	s0,64(sp)
    4df0:	7942                	ld	s2,48(sp)
    4df2:	6161                	addi	sp,sp,80
    4df4:	8082                	ret
    x = -xx;
    4df6:	40b005b3          	neg	a1,a1
    neg = 1;
    4dfa:	4885                	li	a7,1
    x = -xx;
    4dfc:	bfad                	j	4d76 <printint+0x14>

0000000000004dfe <vprintf>:
}
...
{
    4dfe:	711d                	addi	sp,sp,-96
    4e00:	ec86                	sd	ra,88(sp)
    4e02:	e8a2                	sd	s0,80(sp)
    4e04:	e0ca                	sd	s2,64(sp)
    4e06:	1080                	addi	s0,sp,96
  char *s;
  int c0, c1, c2, i, state;

  state = 0;
  for(i = 0; fmt[i]; i++){
    4e08:	0005c903          	lbu	s2,0(a1)
    4e0c:	28090663          	beqz	s2,5098 <vprintf+0x29a>
    4e10:	e4a6                	sd	s1,72(sp)
    4e12:	fc4e                	sd	s3,56(sp)
    4e14:	f852                	sd	s4,48(sp)
    4e16:	f456                	sd	s5,40(sp)
    4e18:	f05a                	sd	s6,32(sp)
    4e1a:	ec5e                	sd	s7,24(sp)
    4e1c:	e862                	sd	s8,16(sp)
    4e1e:	e466                	sd	s9,8(sp)
    4e20:	8b2a                	mv	s6,a0
    4e22:	8a2e                	mv	s4,a1
    4e24:	8bb2                	mv	s7,a2
  state = 0;
  ...
  for(i = 0; fmt[i]; i++){
    ...
    4e2c:	02500a93          	li	s5,37
      c1 = c2 = 0;
      if(c0) c1 = fmt[i+1] & 0xff;
      if(c1) c2 = fmt[i+2] & 0xff;
      if(c0 == 'd'){
    4e30:	06400c13          	li	s8,100
        printint(fd, va_arg(ap, int), 10, 1);
      } else if(c0 == 'l' && c1 == 'd'){
    4e34:	06c00c93          	li	s9,108
    4e38:	a005                	j	4e58 <vprintf+0x5a>
        putc(fd, c0);
    4e3a:	85ca                	mv	a1,s2
    4e3c:	855a                	mv	a0,s6
    4e3e:	f07ff0ef          	jal	4d44 <putc>
    4e42:	a019                	j	4e48 <vprintf+0x4a>
    } else if(state == '%'){
    4e44:	03598263          	beq	s3,s5,4e68 <vprintf+0x6a>
  for(i = 0; fmt[i]; i++){
    4e48:	2485                	addiw	s1,s1,1
    4e4a:	8726                	mv	a4,s1
    4e4c:	009a07b3          	add	a5,s4,s1
    4e50:	0007c903          	lbu	s2,0(a5)
    4e54:	22090a63          	beqz	s2,5088 <vprintf+0x28a>
    c0 = fmt[i] & 0xff;
    4e58:	0009079b          	sext.w	a5,s2
    if(state == 0){
    4e5c:	fe0994e3          	bnez	s3,4e44 <vprintf+0x46>
      if(c0 == '%'){
    4e60:	fd579de3          	bne	a5,s5,4e3a <vprintf+0x3c>
        state = '%';
    4e64:	89be                	mv	s3,a5
    4e66:	b7cd                	j	4e48 <vprintf+0x4a>
      if(c0) c1 = fmt[i+1] & 0xff;
    4e68:	00ea06b3          	add	a3,s4,a4
    4e6c:	0016c683          	lbu	a3,1(a3)
      c1 = c2 = 0;
    4e70:	8636                	mv	a2,a3
      if(c1) c2 = fmt[i+2] & 0xff;
    4e72:	c681                	beqz	a3,4e7a <vprintf+0x7c>
    4e74:	9752                	add	a4,a4,s4
    4e76:	00274603          	lbu	a2,2(a4)
      if(c0 == 'd'){
    4e7a:	05878363          	beq	a5,s8,4ec0 <vprintf+0xc2>
      } else if(c0 == 'l' && c1 == 'd'){
    4e7e:	05978d63          	beq	a5,s9,4ed8 <vprintf+0xda>
    ...
    4e82:	07500713          	li	a4,117
    4e86:	0ee78763          	beq	a5,a4,4f74 <vprintf+0x176>
    ...
    4e8a:	07800713          	li	a4,120
    4e8e:	12e78963          	beq	a5,a4,4fc0 <vprintf+0x1c2>
    ...
    4e92:	07000713          	li	a4,112
    4e96:	14e78e63          	beq	a5,a4,4ff2 <vprintf+0x1f4>
        printptr(fd, va_arg(ap, uint64));
      } else if(c0 == 'c'){
    4e9a:	06300713          	li	a4,99
    4e9e:	18e78e63          	beq	a5,a4,503a <vprintf+0x23c>
        putc(fd, va_arg(ap, uint32));
      } else if(c0 == 's'){
    4ea2:	07300713          	li	a4,115
    4ea6:	1ae78463          	beq	a5,a4,504e <vprintf+0x250>
        if((s = va_arg(ap, char*)) == 0)
          s = "(null)";
        for(; *s; s++)
          putc(fd, *s);
      } else if(c0 == '%'){
    4eaa:	02500713          	li	a4,37
    4eae:	04e79563          	bne	a5,a4,4ef8 <vprintf+0xfa>
        putc(fd, '%');
    4eb2:	02500593          	li	a1,37
    4eb6:	855a                	mv	a0,s6
    4eb8:	e8dff0ef          	jal	4d44 <putc>
      ...
      state = 0;
    4ebc:	4981                	li	s3,0
    4ebe:	b769                	j	4e48 <vprintf+0x4a>
        printint(fd, va_arg(ap, int), 10, 1);
    4ec0:	008b8913          	addi	s2,s7,8
    4ec4:	4685                	li	a3,1
    4ec6:	4629                	li	a2,10
    4ec8:	000ba583          	lw	a1,0(s7)
    4ecc:	855a                	mv	a0,s6
    4ece:	e95ff0ef          	jal	4d62 <printint>
    4ed2:	8bca                	mv	s7,s2
      state = 0;
    4ed4:	4981                	li	s3,0
    4ed6:	bf8d                	j	4e48 <vprintf+0x4a>
      } else if(c0 == 'l' && c1 == 'd'){
    4ed8:	06400793          	li	a5,100
    4edc:	02f68963          	beq	a3,a5,4f0e <vprintf+0x110>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'd'){
    4ee0:	06c00793          	li	a5,108
    4ee4:	04f68263          	beq	a3,a5,4f28 <vprintf+0x12a>
      } else if(c0 == 'l' && c1 == 'u'){
    4ee8:	07500793          	li	a5,117
    4eec:	0af68063          	beq	a3,a5,4f8c <vprintf+0x18e>
      } else if(c0 == 'l' && c1 == 'x'){
    4ef0:	07800793          	li	a5,120
    4ef4:	0ef68263          	beq	a3,a5,4fd8 <vprintf+0x1da>
        putc(fd, '%');
    4ef8:	02500593          	li	a1,37
    4efc:	855a                	mv	a0,s6
    4efe:	e47ff0ef          	jal	4d44 <putc>
        putc(fd, c0);
    4f02:	85ca                	mv	a1,s2
    4f04:	855a                	mv	a0,s6
    4f06:	e3fff0ef          	jal	4d44 <putc>
      state = 0;
    4f0a:	4981                	li	s3,0
    4f0c:	bf35                	j	4e48 <vprintf+0x4a>
        printint(fd, va_arg(ap, uint64), 10, 1);
    4f0e:	008b8913          	addi	s2,s7,8
    4f12:	4685                	li	a3,1
    4f14:	4629                	li	a2,10
    4f16:	000bb583          	ld	a1,0(s7)
    4f1a:	855a                	mv	a0,s6
    4f1c:	e47ff0ef          	jal	4d62 <printint>
        i += 1;
    ...
    4f24:	4981                	li	s3,0
        i += 1;
    4f26:	b70d                	j	4e48 <vprintf+0x4a>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'd'){
    4f28:	06400793          	li	a5,100
    4f2c:	02f60763          	beq	a2,a5,4f5a <vprintf+0x15c>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'u'){
    4f30:	07500793          	li	a5,117
    4f34:	06f60963          	beq	a2,a5,4fa6 <vprintf+0x1a8>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'x'){
    4f38:	07800793          	li	a5,120
    4f3c:	faf61ee3          	bne	a2,a5,4ef8 <vprintf+0xfa>
        printint(fd, va_arg(ap, uint64), 16, 0);
    ...
    4f4c:	855a                	mv	a0,s6
    4f4e:	e15ff0ef          	jal	4d62 <printint>
        i += 2;
    ...
    4f56:	4981                	li	s3,0
        i += 2;
    4f58:	bdc5                	j	4e48 <vprintf+0x4a>
        printint(fd, va_arg(ap, uint64), 10, 1);
    4f5a:	008b8913          	addi	s2,s7,8
    4f5e:	4685                	li	a3,1
    4f60:	4629                	li	a2,10
    4f62:	000bb583          	ld	a1,0(s7)
    4f66:	855a                	mv	a0,s6
    4f68:	dfbff0ef          	jal	4d62 <printint>
        i += 2;
    4f6c:	2489                	addiw	s1,s1,2
        printint(fd, va_arg(ap, uint64), 10, 1);
    4f6e:	8bca                	mv	s7,s2
      state = 0;
    4f70:	4981                	li	s3,0
        i += 2;
    4f72:	bdd9                	j	4e48 <vprintf+0x4a>
        printint(fd, va_arg(ap, uint32), 10, 0);
    4f74:	008b8913          	addi	s2,s7,8
    4f78:	4681                	li	a3,0
    4f7a:	4629                	li	a2,10
    4f7c:	000be583          	lwu	a1,0(s7)
    4f80:	855a                	mv	a0,s6
    4f82:	de1ff0ef          	jal	4d62 <printint>
    4f86:	8bca                	mv	s7,s2
      state = 0;
    4f88:	4981                	li	s3,0
    4f8a:	bd7d                	j	4e48 <vprintf+0x4a>
        printint(fd, va_arg(ap, uint64), 10, 0);
    4f8c:	008b8913          	addi	s2,s7,8
    4f90:	4681                	li	a3,0
    4f92:	4629                	li	a2,10
    4f94:	000bb583          	ld	a1,0(s7)
    4f98:	855a                	mv	a0,s6
    4f9a:	dc9ff0ef          	jal	4d62 <printint>
        i += 1;
    4f9e:	2485                	addiw	s1,s1,1
        printint(fd, va_arg(ap, uint64), 10, 0);
    4fa0:	8bca                	mv	s7,s2
      state = 0;
    4fa2:	4981                	li	s3,0
        i += 1;
    4fa4:	b555                	j	4e48 <vprintf+0x4a>
        printint(fd, va_arg(ap, uint64), 10, 0);
    4fa6:	008b8913          	addi	s2,s7,8
    4faa:	4681                	li	a3,0
    4fac:	4629                	li	a2,10
    4fae:	000bb583          	ld	a1,0(s7)
    4fb2:	855a                	mv	a0,s6
    4fb4:	dafff0ef          	jal	4d62 <printint>
        i += 2;
    4fb8:	2489                	addiw	s1,s1,2
        printint(fd, va_arg(ap, uint64), 10, 0);
    4fba:	8bca                	mv	s7,s2
      state = 0;
    4fbc:	4981                	li	s3,0
        i += 2;
    4fbe:	b569                	j	4e48 <vprintf+0x4a>
        printint(fd, va_arg(ap, uint32), 16, 0);
    4fc0:	008b8913          	addi	s2,s7,8
    4fc4:	4681                	li	a3,0
    4fc6:	4641                	li	a2,16
    4fc8:	000be583          	lwu	a1,0(s7)
    4fcc:	855a                	mv	a0,s6
    4fce:	d95ff0ef          	jal	4d62 <printint>
    4fd2:	8bca                	mv	s7,s2
      state = 0;
    4fd4:	4981                	li	s3,0
    4fd6:	bd8d                	j	4e48 <vprintf+0x4a>
        printint(fd, va_arg(ap, uint64), 16, 0);
    4fd8:	008b8913          	addi	s2,s7,8
    4fdc:	4681                	li	a3,0
    4fde:	4641                	li	a2,16
    4fe0:	000bb583          	ld	a1,0(s7)
    4fe4:	855a                	mv	a0,s6
    4fe6:	d7dff0ef          	jal	4d62 <printint>
        i += 1;
    4fea:	2485                	addiw	s1,s1,1
        printint(fd, va_arg(ap, uint64), 16, 0);
    4fec:	8bca                	mv	s7,s2
      state = 0;
    4fee:	4981                	li	s3,0
        i += 1;
    4ff0:	bda1                	j	4e48 <vprintf+0x4a>
    4ff2:	e06a                	sd	s10,0(sp)
        printptr(fd, va_arg(ap, uint64));
    4ff4:	008b8d13          	addi	s10,s7,8
    4ff8:	000bb983          	ld	s3,0(s7)
  putc(fd, '0');
    4ffc:	03000593          	li	a1,48
    5000:	855a                	mv	a0,s6
    5002:	d43ff0ef          	jal	4d44 <putc>
  putc(fd, 'x');
    5006:	07800593          	li	a1,120
    500a:	855a                	mv	a0,s6
    500c:	d39ff0ef          	jal	4d44 <putc>
    5010:	4941                	li	s2,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    5012:	00002b97          	auipc	s7,0x2
    5016:	79eb8b93          	addi	s7,s7,1950 # 77b0 <digits>
    501a:	03c9d793          	srli	a5,s3,0x3c
    501e:	97de                	add	a5,a5,s7
    5020:	0007c583          	lbu	a1,0(a5)
    5024:	855a                	mv	a0,s6
    5026:	d1fff0ef          	jal	4d44 <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    502a:	0992                	slli	s3,s3,0x4
    502c:	397d                	addiw	s2,s2,-1
    502e:	fe0916e3          	bnez	s2,501a <vprintf+0x21c>
        printptr(fd, va_arg(ap, uint64));
    5032:	8bea                	mv	s7,s10
      state = 0;
    5034:	4981                	li	s3,0
    5036:	6d02                	ld	s10,0(sp)
    5038:	bd01                	j	4e48 <vprintf+0x4a>
        putc(fd, va_arg(ap, uint32));
    503a:	008b8913          	addi	s2,s7,8
    503e:	000bc583          	lbu	a1,0(s7)
    5042:	855a                	mv	a0,s6
    5044:	d01ff0ef          	jal	4d44 <putc>
    5048:	8bca                	mv	s7,s2
      state = 0;
    504a:	4981                	li	s3,0
    504c:	bbf5                	j	4e48 <vprintf+0x4a>
        if((s = va_arg(ap, char*)) == 0)
    504e:	008b8993          	addi	s3,s7,8
    5052:	000bb903          	ld	s2,0(s7)
    5056:	00090f63          	beqz	s2,5074 <vprintf+0x276>
        for(; *s; s++)
    505a:	00094583          	lbu	a1,0(s2)
    505e:	c195                	beqz	a1,5082 <vprintf+0x284>
          putc(fd, *s);
    5060:	855a                	mv	a0,s6
    5062:	ce3ff0ef          	jal	4d44 <putc>
        for(; *s; s++)
    5066:	0905                	addi	s2,s2,1
    5068:	00094583          	lbu	a1,0(s2)
    506c:	f9f5                	bnez	a1,5060 <vprintf+0x262>
        if((s = va_arg(ap, char*)) == 0)
    506e:	8bce                	mv	s7,s3
      state = 0;
    5070:	4981                	li	s3,0
    5072:	bbd9                	j	4e48 <vprintf+0x4a>
          s = "(null)";
    5074:	00002917          	auipc	s2,0x2
    5078:	68c90913          	addi	s2,s2,1676 # 7700 <malloc+0x2580>
        for(; *s; s++)
    507c:	02800593          	li	a1,40
    5080:	b7c5                	j	5060 <vprintf+0x262>
        if((s = va_arg(ap, char*)) == 0)
    5082:	8bce                	mv	s7,s3
      state = 0;
    5084:	4981                	li	s3,0
    5086:	b3c9                	j	4e48 <vprintf+0x4a>
    5088:	64a6                	ld	s1,72(sp)
    508a:	79e2                	ld	s3,56(sp)
    508c:	7a42                	ld	s4,48(sp)
    508e:	7aa2                	ld	s5,40(sp)
    5090:	7b02                	ld	s6,32(sp)
    5092:	6be2                	ld	s7,24(sp)
    5094:	6c42                	ld	s8,16(sp)
    5096:	6ca2                	ld	s9,8(sp)
    }
  }
}
    5098:	60e6                	ld	ra,88(sp)
    509a:	6446                	ld	s0,80(sp)
    509c:	6906                	ld	s2,64(sp)
    509e:	6125                	addi	sp,sp,96
    50a0:	8082                	ret

00000000000050a2 <fprintf>:

void
fprintf(int fd, const char *fmt, ...)
{
    50a2:	715d                	addi	sp,sp,-80
    50a4:	ec06                	sd	ra,24(sp)
    50a6:	e822                	sd	s0,16(sp)
    50a8:	1000                	addi	s0,sp,32
    50aa:	e010                	sd	a2,0(s0)
    50ac:	e414                	sd	a3,8(s0)
    50ae:	e818                	sd	a4,16(s0)
    50b0:	ec1c                	sd	a5,24(s0)
    50b2:	03043023          	sd	a6,32(s0)
    50b6:	03143423          	sd	a7,40(s0)
  va_list ap;

  va_start(ap, fmt);
    50ba:	fe843423          	sd	s0,-24(s0)
  vprintf(fd, fmt, ap);
    50be:	8622                	mv	a2,s0
    50c0:	d3fff0ef          	jal	4dfe <vprintf>
}
    50c4:	60e2                	ld	ra,24(sp)
    50c6:	6442                	ld	s0,16(sp)
    50c8:	6161                	addi	sp,sp,80
    50ca:	8082                	ret

00000000000050cc <printf>:

void
printf(const char *fmt, ...)
{
    50cc:	711d                	addi	sp,sp,-96
    50ce:	ec06                	sd	ra,24(sp)
    50d0:	e822                	sd	s0,16(sp)
    50d2:	1000                	addi	s0,sp,32
    50d4:	e40c                	sd	a1,8(s0)
    50d6:	e810                	sd	a2,16(s0)
    50d8:	ec14                	sd	a3,24(s0)
    50da:	f018                	sd	a4,32(s0)
    50dc:	f41c                	sd	a5,40(s0)
    50de:	03043823          	sd	a6,48(s0)
    50e2:	03143c23          	sd	a7,56(s0)
  va_list ap;

  va_start(ap, fmt);
    50e6:	00840613          	addi	a2,s0,8
    50ea:	fec43423          	sd	a2,-24(s0)
  vprintf(1, fmt, ap);
    50ee:	85aa                	mv	a1,a0
    50f0:	4505                	li	a0,1
    50f2:	d0dff0ef          	jal	4dfe <vprintf>
}
    50f6:	60e2                	ld	ra,24(sp)
    50f8:	6442                	ld	s0,16(sp)
    50fa:	6125                	addi	sp,sp,96
    50fc:	8082                	ret

00000000000050fe <free>:
static Header base;
static Header *freep;
...
free(void *ap)
{
  ...
  bp = (Header*)ap - 1;
    5104:	ff050693          	addi	a3,a0,-16
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    5108:	00004797          	auipc	a5,0x4
    510c:	3787b783          	ld	a5,888(a5) # 9480 <freep>
    5110:	a02d                	j	513a <free+0x3c>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
    bp->s.size += p->s.ptr->s.size;
    5112:	4618                	lw	a4,8(a2)
    5114:	9f2d                	addw	a4,a4,a1
    5116:	fee52c23          	sw	a4,-8(a0)
    bp->s.ptr = p->s.ptr->s.ptr;
    511a:	6398                	ld	a4,0(a5)
    511c:	6310                	ld	a2,0(a4)
    511e:	a83d                	j	515c <free+0x5e>
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
    p->s.size += bp->s.size;
    5120:	ff852703          	lw	a4,-8(a0)
    5124:	9f31                	addw	a4,a4,a2
    5126:	c798                	sw	a4,8(a5)
    p->s.ptr = bp->s.ptr;
    5128:	ff053683          	ld	a3,-16(a0)
    512c:	a091                	j	5170 <free+0x72>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    512e:	6398                	ld	a4,0(a5)
    5130:	00e7e463          	bltu	a5,a4,5138 <free+0x3a>
    5134:	00e6ea63          	bltu	a3,a4,5148 <free+0x4a>
{
    5138:	87ba                	mv	a5,a4
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    513a:	fed7fae3          	bgeu	a5,a3,512e <free+0x30>
    513e:	6398                	ld	a4,0(a5)
    5140:	00e6e463          	bltu	a3,a4,5148 <free+0x4a>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    5144:	fee7eae3          	bltu	a5,a4,5138 <free+0x3a>
  if(bp + bp->s.size == p->s.ptr){
    5148:	ff852583          	lw	a1,-8(a0)
    514c:	6390                	ld	a2,0(a5)
    514e:	02059813          	slli	a6,a1,0x20
    5152:	01c85713          	srli	a4,a6,0x1c
    5156:	9736                	add	a4,a4,a3
    5158:	fae60de3          	beq	a2,a4,5112 <free+0x14>
    bp->s.ptr = p->s.ptr->s.ptr;
    515c:	fec53823          	sd	a2,-16(a0)
  if(p + p->s.size == bp){
    5160:	4790                	lw	a2,8(a5)
    5162:	02061593          	slli	a1,a2,0x20
    5166:	01c5d713          	srli	a4,a1,0x1c
    516a:	973e                	add	a4,a4,a5
    516c:	fae68ae3          	beq	a3,a4,5120 <free+0x22>
    p->s.ptr = bp->s.ptr;
    5170:	e394                	sd	a3,0(a5)
  } else
    p->s.ptr = bp;
  freep = p;
    5172:	00004717          	auipc	a4,0x4
    5176:	30f73723          	sd	a5,782(a4) # 9480 <freep>
}
    517a:	6422                	ld	s0,8(sp)
    517c:	0141                	addi	sp,sp,16
    517e:	8082                	ret

0000000000005180 <malloc>:
  return freep;
}
...
malloc(uint nbytes)
{
    5180:	7139                	addi	sp,sp,-64
    5182:	fc06                	sd	ra,56(sp)
    5184:	f822                	sd	s0,48(sp)
    5186:	f426                	sd	s1,40(sp)
    5188:	ec4e                	sd	s3,24(sp)
    518a:	0080                	addi	s0,sp,64
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    518c:	02051493          	slli	s1,a0,0x20
    5190:	9081                	srli	s1,s1,0x20
    5192:	04bd                	addi	s1,s1,15
    5194:	8091                	srli	s1,s1,0x4
    5196:	0014899b          	addiw	s3,s1,1
    519a:	0485                	addi	s1,s1,1
  if((prevp = freep) == 0){
    519c:	00004517          	auipc	a0,0x4
    51a0:	2e453503          	ld	a0,740(a0) # 9480 <freep>
    51a4:	c915                	beqz	a0,51d8 <malloc+0x58>
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    51a6:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    51a8:	4798                	lw	a4,8(a5)
    51aa:	08977a63          	bgeu	a4,s1,523e <malloc+0xbe>
    51ae:	f04a                	sd	s2,32(sp)
    51b0:	e852                	sd	s4,16(sp)
    51b2:	e456                	sd	s5,8(sp)
    51b4:	e05a                	sd	s6,0(sp)
  if(nu < 4096)
    51b6:	8a4e                	mv	s4,s3
    51b8:	0009871b          	sext.w	a4,s3
    51bc:	6685                	lui	a3,0x1
    51be:	00d77363          	bgeu	a4,a3,51c4 <malloc+0x44>
    51c2:	6a05                	lui	s4,0x1
    51c4:	000a0b1b          	sext.w	s6,s4
  p = sbrk(nu * sizeof(Header));
    51c8:	004a1a1b          	slliw	s4,s4,0x4
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
    ...
    if(p == freep)
    51cc:	00004917          	auipc	s2,0x4
    51d0:	2b490913          	addi	s2,s2,692 # 9480 <freep>
  if(p == SBRK_ERROR)
    51d4:	5afd                	li	s5,-1
    51d6:	a081                	j	5216 <malloc+0x96>
    51d8:	f04a                	sd	s2,32(sp)
    51da:	e852                	sd	s4,16(sp)
    51dc:	e456                	sd	s5,8(sp)
    51de:	e05a                	sd	s6,0(sp)
    base.s.ptr = freep = prevp = &base;
    51e0:	0000b797          	auipc	a5,0xb
    51e4:	ac878793          	addi	a5,a5,-1336 # fca8 <base>
    51e8:	00004717          	auipc	a4,0x4
    51ec:	28f73c23          	sd	a5,664(a4) # 9480 <freep>
    51f0:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
    51f2:	0007a423          	sw	zero,8(a5)
    if(p->s.size >= nunits){
    51f6:	b7c1                	j	51b6 <malloc+0x36>
        prevp->s.ptr = p->s.ptr;
    51f8:	6398                	ld	a4,0(a5)
    51fa:	e118                	sd	a4,0(a0)
    51fc:	a8a9                	j	5256 <malloc+0xd6>
  hp->s.size = nu;
    51fe:	01652423          	sw	s6,8(a0)
  free((void*)(hp + 1));
    5202:	0541                	addi	a0,a0,16
    5204:	efbff0ef          	jal	50fe <free>
  return freep;
    5208:	00093503          	ld	a0,0(s2)
      if((p = morecore(nunits)) == 0)
    520c:	c12d                	beqz	a0,526e <malloc+0xee>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    520e:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    5210:	4798                	lw	a4,8(a5)
    5212:	02977263          	bgeu	a4,s1,5236 <malloc+0xb6>
    if(p == freep)
    5216:	00093703          	ld	a4,0(s2)
    521a:	853e                	mv	a0,a5
    521c:	fef719e3          	bne	a4,a5,520e <malloc+0x8e>
  p = sbrk(nu * sizeof(Header));
    5220:	8552                	mv	a0,s4
    5222:	a2fff0ef          	jal	4c50 <sbrk>
  if(p == SBRK_ERROR)
    5226:	fd551ce3          	bne	a0,s5,51fe <malloc+0x7e>
        return 0;
    522a:	4501                	li	a0,0
    522c:	7902                	ld	s2,32(sp)
    522e:	6a42                	ld	s4,16(sp)
    5230:	6aa2                	ld	s5,8(sp)
    5232:	6b02                	ld	s6,0(sp)
    5234:	a03d                	j	5262 <malloc+0xe2>
    5236:	7902                	ld	s2,32(sp)
    5238:	6a42                	ld	s4,16(sp)
    523a:	6aa2                	ld	s5,8(sp)
    523c:	6b02                	ld	s6,0(sp)
      if(p->s.size == nunits)
    523e:	fae48de3          	beq	s1,a4,51f8 <malloc+0x78>
        p->s.size -= nunits;
    5242:	4137073b          	subw	a4,a4,s3
    5246:	c798                	sw	a4,8(a5)
        p += p->s.size;
    5248:	02071693          	slli	a3,a4,0x20
    524c:	01c6d713          	srli	a4,a3,0x1c
    5250:	97ba                	add	a5,a5,a4
        p->s.size = nunits;
    5252:	0137a423          	sw	s3,8(a5)
      freep = prevp;
    5256:	00004717          	auipc	a4,0x4
    525a:	22a73523          	sd	a0,554(a4) # 9480 <freep>
      return (void*)(p + 1);
    525e:	01078513          	addi	a0,a5,16
  }
}
    5262:	70e2                	ld	ra,56(sp)
    5264:	7442                	ld	s0,48(sp)
    5266:	74a2                	ld	s1,40(sp)
    5268:	69e2                	ld	s3,24(sp)
    526a:	6121                	addi	sp,sp,64
    526c:	8082                	ret
    526e:	7902                	ld	s2,32(sp)
    5270:	6a42                	ld	s4,16(sp)
    5272:	6aa2                	ld	s5,8(sp)
    5274:	6b02                	ld	s6,0(sp)
    5276:	b7f5                	j	5262 <malloc+0xe2>
