...
int main(int argc, char * argv[])
{
  ...
  16:	8de50513          	addi	a0,a0,-1826 # 8f0 <malloc+0x106>
  1a:	71c000ef          	jal	736 <printf>
        exit(1);
  1e:	4505                	li	a0,1
  ...
  28:	84ae                	mv	s1,a1
    ...
    int pid = atoi(argv[1]);
  2a:	6588                	ld	a0,8(a1)
  2c:	1a0000ef          	jal	1cc <atoi>
  30:	892a                	mv	s2,a0
    int priority = atoi(argv[2]);
  32:	6888                	ld	a0,16(s1)
  34:	198000ef          	jal	1cc <atoi>
  38:	85aa                	mv	a1,a0
    int p = set_priority(pid, priority); 
  3a:	854a                	mv	a0,s2
  3c:	35a000ef          	jal	396 <set_priority>
    if(p != 0)
  40:	c911                	beqz	a0,54 <main+0x54>
    {
        printf("ERROR: Priority Not Set\n");
  42:	00001517          	auipc	a0,0x1
  46:	8c650513          	addi	a0,a0,-1850 # 908 <malloc+0x11e>
...
printint(int fd, long long xx, int base, int sgn)
{
 ...
 3ea:	54a50513          	addi	a0,a0,1354 # 930 <digits>
 3ee:	883e                	mv	a6,a5
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 680:	2b4b8b93          	addi	s7,s7,692 # 930 <digits>
 ...
 6e2:	24a90913          	addi	s2,s2,586 # 928 <malloc+0x13e>
        for(; *s; s++)
